#ifndef SAMD21E_INTERRUPTS_H
#define SAMD21E_INTERRUPTS_H
...
void push_SERCOM0_Handler(void (*isr_handler)(uint8_t));
void push_SERCOM1_Handler(void (*isr_handler)(uint8_t));
void push_SERCOM2_Handler(void (*isr_handler)(uint8_t));
void push_SERCOM3_Handler(void (*isr_handler)(uint8_t));
void push_Reserved13(void (*isr_handler)(void));
void push_Reserved14(void (*isr_handler)(void));
void push_TCC0_Handler(void (*isr_handler)(uint8_t));
void push_TCC1_Handler(void (*isr_handler)(uint8_t));
void push_TCC2_Handler(void (*isr_handler)(uint8_t));
void push_TC3_Handler(void (*isr_handler)(uint8_t));
void push_TC4_Handler(void (*isr_handler)(uint8_t));
void push_TC5_Handler(void (*isr_handler)(uint8_t));
