...
#define FUSES_TEMP_LOG_WORD_0_ROOM_TEMP_VAL_INT(value) (FUSES_TEMP_LOG_WORD_0_ROOM_TEMP_VAL_INT_Msk & (_UINT32_(value) << FUSES_TEMP_LOG_WORD_0_ROOM_TEMP_VAL_INT_Pos)) /* Assignment of value for ROOM_TEMP_VAL_INT in the FUSES_TEMP_LOG_WORD_0 register */
...
#define FUSES_TEMP_LOG_WORD_0_ROOM_TEMP_VAL_DEC(value) (FUSES_TEMP_LOG_WORD_0_ROOM_TEMP_VAL_DEC_Msk & (_UINT32_(value) << FUSES_TEMP_LOG_WORD_0_ROOM_TEMP_VAL_DEC_Pos)) /* Assignment of value for ROOM_TEMP_VAL_DEC in the FUSES_TEMP_LOG_WORD_0 register */
...
#define FUSES_TEMP_LOG_WORD_0_HOT_TEMP_VAL_INT(value) (FUSES_TEMP_LOG_WORD_0_HOT_TEMP_VAL_INT_Msk & (_UINT32_(value) << FUSES_TEMP_LOG_WORD_0_HOT_TEMP_VAL_INT_Pos)) /* Assignment of value for HOT_TEMP_VAL_INT in the FUSES_TEMP_LOG_WORD_0 register */
...
#define FUSES_TEMP_LOG_WORD_0_HOT_TEMP_VAL_DEC(value) (FUSES_TEMP_LOG_WORD_0_HOT_TEMP_VAL_DEC_Msk & (_UINT32_(value) << FUSES_TEMP_LOG_WORD_0_HOT_TEMP_VAL_DEC_Pos)) /* Assignment of value for HOT_TEMP_VAL_DEC in the FUSES_TEMP_LOG_WORD_0 register */
...
#define FUSES_TEMP_LOG_WORD_0_ROOM_INT1V_VAL(value) (FUSES_TEMP_LOG_WORD_0_ROOM_INT1V_VAL_Msk & (_UINT32_(value) << FUSES_TEMP_LOG_WORD_0_ROOM_INT1V_VAL_Pos)) /* Assignment of value for ROOM_INT1V_VAL in the FUSES_TEMP_LOG_WORD_0 register */
...
#define FUSES_TEMP_LOG_WORD_1_HOT_INT1V_VAL(value) (FUSES_TEMP_LOG_WORD_1_HOT_INT1V_VAL_Msk & (_UINT32_(value) << FUSES_TEMP_LOG_WORD_1_HOT_INT1V_VAL_Pos)) /* Assignment of value for HOT_INT1V_VAL in the FUSES_TEMP_LOG_WORD_1 register */
...
#define FUSES_TEMP_LOG_WORD_1_ROOM_ADC_VAL(value) (FUSES_TEMP_LOG_WORD_1_ROOM_ADC_VAL_Msk & (_UINT32_(value) << FUSES_TEMP_LOG_WORD_1_ROOM_ADC_VAL_Pos)) /* Assignment of value for ROOM_ADC_VAL in the FUSES_TEMP_LOG_WORD_1 register */
...
#define FUSES_TEMP_LOG_WORD_1_HOT_ADC_VAL(value) (FUSES_TEMP_LOG_WORD_1_HOT_ADC_VAL_Msk & (_UINT32_(value) << FUSES_TEMP_LOG_WORD_1_HOT_ADC_VAL_Pos)) /* Assignment of value for HOT_ADC_VAL in the FUSES_TEMP_LOG_WORD_1 register */
...
#define FUSES_AUX3_WORD_3_SERIAL_NUMBER_3(value) (FUSES_AUX3_WORD_3_SERIAL_NUMBER_3_Msk & (_UINT32_(value) << FUSES_AUX3_WORD_3_SERIAL_NUMBER_3_Pos)) /* Assignment of value for SERIAL_NUMBER_3 in the FUSES_AUX3_WORD_3 register */
...
#define FUSES_AUX3_WORD_16_SERIAL_NUMBER_0(value) (FUSES_AUX3_WORD_16_SERIAL_NUMBER_0_Msk & (_UINT32_(value) << FUSES_AUX3_WORD_16_SERIAL_NUMBER_0_Pos)) /* Assignment of value for SERIAL_NUMBER_0 in the FUSES_AUX3_WORD_16 register */
...
#define FUSES_AUX3_WORD_17_SERIAL_NUMBER_1(value) (FUSES_AUX3_WORD_17_SERIAL_NUMBER_1_Msk & (_UINT32_(value) << FUSES_AUX3_WORD_17_SERIAL_NUMBER_1_Pos)) /* Assignment of value for SERIAL_NUMBER_1 in the FUSES_AUX3_WORD_17 register */
...
#define FUSES_AUX3_WORD_18_SERIAL_NUMBER_2(value) (FUSES_AUX3_WORD_18_SERIAL_NUMBER_2_Msk & (_UINT32_(value) << FUSES_AUX3_WORD_18_SERIAL_NUMBER_2_Pos)) /* Assignment of value for SERIAL_NUMBER_2 in the FUSES_AUX3_WORD_18 register */
...
#define FUSES_OTP4_WORD_0_ADC_LINEARITY_0(value) (FUSES_OTP4_WORD_0_ADC_LINEARITY_0_Msk & (_UINT32_(value) << FUSES_OTP4_WORD_0_ADC_LINEARITY_0_Pos)) /* Assignment of value for ADC_LINEARITY_0 in the FUSES_OTP4_WORD_0 register */
...
#define FUSES_OTP4_WORD_1_ADC_LINEARITY_1(value) (FUSES_OTP4_WORD_1_ADC_LINEARITY_1_Msk & (_UINT32_(value) << FUSES_OTP4_WORD_1_ADC_LINEARITY_1_Pos)) /* Assignment of value for ADC_LINEARITY_1 in the FUSES_OTP4_WORD_1 register */
...
#define FUSES_OTP4_WORD_1_ADC_BIASCAL(value)  (FUSES_OTP4_WORD_1_ADC_BIASCAL_Msk & (_UINT32_(value) << FUSES_OTP4_WORD_1_ADC_BIASCAL_Pos)) /* Assignment of value for ADC_BIASCAL in the FUSES_OTP4_WORD_1 register */
...
#define FUSES_OTP4_WORD_1_OSC32K_CAL(value)   (FUSES_OTP4_WORD_1_OSC32K_CAL_Msk & (_UINT32_(value) << FUSES_OTP4_WORD_1_OSC32K_CAL_Pos)) /* Assignment of value for OSC32K_CAL in the FUSES_OTP4_WORD_1 register */
...
#define FUSES_OTP4_WORD_1_USB_TRANSN(value)   (FUSES_OTP4_WORD_1_USB_TRANSN_Msk & (_UINT32_(value) << FUSES_OTP4_WORD_1_USB_TRANSN_Pos)) /* Assignment of value for USB_TRANSN in the FUSES_OTP4_WORD_1 register */
...
#define FUSES_OTP4_WORD_1_USB_TRANSP(value)   (FUSES_OTP4_WORD_1_USB_TRANSP_Msk & (_UINT32_(value) << FUSES_OTP4_WORD_1_USB_TRANSP_Pos)) /* Assignment of value for USB_TRANSP in the FUSES_OTP4_WORD_1 register */
...
#define FUSES_OTP4_WORD_1_USB_TRIM(value)     (FUSES_OTP4_WORD_1_USB_TRIM_Msk & (_UINT32_(value) << FUSES_OTP4_WORD_1_USB_TRIM_Pos)) /* Assignment of value for USB_TRIM in the FUSES_OTP4_WORD_1 register */
...
#define FUSES_OTP4_WORD_1_DFLL48M_COARSE_CAL(value) (FUSES_OTP4_WORD_1_DFLL48M_COARSE_CAL_Msk & (_UINT32_(value) << FUSES_OTP4_WORD_1_DFLL48M_COARSE_CAL_Pos)) /* Assignment of value for DFLL48M_COARSE_CAL in the FUSES_OTP4_WORD_1 register */
...
#define FUSES_OTP4_WORD_2_DFLL48M_FINE_CAL(value) (FUSES_OTP4_WORD_2_DFLL48M_FINE_CAL_Msk & (_UINT32_(value) << FUSES_OTP4_WORD_2_DFLL48M_FINE_CAL_Pos)) /* Assignment of value for DFLL48M_FINE_CAL in the FUSES_OTP4_WORD_2 register */
...
#define FUSES_USER_WORD_0_NVMCTRL_BOOTPROT(value) (FUSES_USER_WORD_0_NVMCTRL_BOOTPROT_Msk & (_UINT32_(value) << FUSES_USER_WORD_0_NVMCTRL_BOOTPROT_Pos)) /* Assignment of value for NVMCTRL_BOOTPROT in the FUSES_USER_WORD_0 register */
...
#define FUSES_USER_WORD_0_NVMCTRL_EEPROM_SIZE(value) (FUSES_USER_WORD_0_NVMCTRL_EEPROM_SIZE_Msk & (_UINT32_(value) << FUSES_USER_WORD_0_NVMCTRL_EEPROM_SIZE_Pos)) /* Assignment of value for NVMCTRL_EEPROM_SIZE in the FUSES_USER_WORD_0 register */
...
#define FUSES_USER_WORD_0_BOD33USERLEVEL(value) (FUSES_USER_WORD_0_BOD33USERLEVEL_Msk & (_UINT32_(value) << FUSES_USER_WORD_0_BOD33USERLEVEL_Pos)) /* Assignment of value for BOD33USERLEVEL in the FUSES_USER_WORD_0 register */
...
#define FUSES_USER_WORD_0_BOD33_EN(value)     (FUSES_USER_WORD_0_BOD33_EN_Msk & (_UINT32_(value) << FUSES_USER_WORD_0_BOD33_EN_Pos)) /* Assignment of value for BOD33_EN in the FUSES_USER_WORD_0 register */
...
#define FUSES_USER_WORD_0_BOD33_ACTION(value) (FUSES_USER_WORD_0_BOD33_ACTION_Msk & (_UINT32_(value) << FUSES_USER_WORD_0_BOD33_ACTION_Pos)) /* Assignment of value for BOD33_ACTION in the FUSES_USER_WORD_0 register */
...
#define FUSES_USER_WORD_0_WDT_ENABLE(value)   (FUSES_USER_WORD_0_WDT_ENABLE_Msk & (_UINT32_(value) << FUSES_USER_WORD_0_WDT_ENABLE_Pos)) /* Assignment of value for WDT_ENABLE in the FUSES_USER_WORD_0 register */
...
#define FUSES_USER_WORD_0_WDT_ALWAYSON(value) (FUSES_USER_WORD_0_WDT_ALWAYSON_Msk & (_UINT32_(value) << FUSES_USER_WORD_0_WDT_ALWAYSON_Pos)) /* Assignment of value for WDT_ALWAYSON in the FUSES_USER_WORD_0 register */
...
#define FUSES_USER_WORD_0_WDT_PER(value)      (FUSES_USER_WORD_0_WDT_PER_Msk & (_UINT32_(value) << FUSES_USER_WORD_0_WDT_PER_Pos)) /* Assignment of value for WDT_PER in the FUSES_USER_WORD_0 register */
...
#define FUSES_USER_WORD_0_WDT_WINDOW_0(value) (FUSES_USER_WORD_0_WDT_WINDOW_0_Msk & (_UINT32_(value) << FUSES_USER_WORD_0_WDT_WINDOW_0_Pos)) /* Assignment of value for WDT_WINDOW_0 in the FUSES_USER_WORD_0 register */
...
#define FUSES_USER_WORD_1_WDT_WINDOW_1(value) (FUSES_USER_WORD_1_WDT_WINDOW_1_Msk & (_UINT32_(value) << FUSES_USER_WORD_1_WDT_WINDOW_1_Pos)) /* Assignment of value for WDT_WINDOW_1 in the FUSES_USER_WORD_1 register */
...
#define FUSES_USER_WORD_1_WDT_EWOFFSET(value) (FUSES_USER_WORD_1_WDT_EWOFFSET_Msk & (_UINT32_(value) << FUSES_USER_WORD_1_WDT_EWOFFSET_Pos)) /* Assignment of value for WDT_EWOFFSET in the FUSES_USER_WORD_1 register */
...
#define FUSES_USER_WORD_1_WDT_WEN(value)      (FUSES_USER_WORD_1_WDT_WEN_Msk & (_UINT32_(value) << FUSES_USER_WORD_1_WDT_WEN_Pos)) /* Assignment of value for WDT_WEN in the FUSES_USER_WORD_1 register */
...
#define FUSES_USER_WORD_1_BOD33_HYST(value)   (FUSES_USER_WORD_1_BOD33_HYST_Msk & (_UINT32_(value) << FUSES_USER_WORD_1_BOD33_HYST_Pos)) /* Assignment of value for BOD33_HYST in the FUSES_USER_WORD_1 register */
...
#define FUSES_USER_WORD_1_NVMCTRL_REGION_LOCKS(value) (FUSES_USER_WORD_1_NVMCTRL_REGION_LOCKS_Msk & (_UINT32_(value) << FUSES_USER_WORD_1_NVMCTRL_REGION_LOCKS_Pos)) /* Assignment of value for NVMCTRL_REGION_LOCKS in the FUSES_USER_WORD_1 register */
...
/* TEMP_LOG_FUSES register API structure */
typedef struct
{
...
/* AUX3_FUSES register API structure */
typedef struct
{
...
/* OTP4_FUSES register API structure */
typedef struct
{
...
/* USER_FUSES register API structure */
typedef struct
{
