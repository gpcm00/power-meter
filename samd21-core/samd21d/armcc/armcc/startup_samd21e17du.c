/*
 * ARMCC startup file for ATSAMD21E17DU
 *
...
// Check if DeviceVectors is defined and create a typedef to VECTOR_TABLE_Type
    ...
    typedef DeviceVectors VECTOR_TABLE_Type; // Defines the toolchain agnostic type of the vector table type defined in the 'samd21e17du.h'
...
void TCC3_Handler         ( void ) __attribute__ ((weak, alias("Default_Handler")));
