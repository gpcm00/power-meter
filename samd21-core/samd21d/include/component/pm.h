...
#define PM_SLEEP_IDLE(value)                  (PM_SLEEP_IDLE_Msk & (_UINT8_(value) << PM_SLEEP_IDLE_Pos)) /* Assignment of value for IDLE in the PM_SLEEP register */
...
#define PM_EXTCTRL_SETDIS(value)              (PM_EXTCTRL_SETDIS_Msk & (_UINT8_(value) << PM_EXTCTRL_SETDIS_Pos)) /* Assignment of value for SETDIS in the PM_EXTCTRL register */
...
#define PM_CPUSEL_CPUDIV(value)               (PM_CPUSEL_CPUDIV_Msk & (_UINT8_(value) << PM_CPUSEL_CPUDIV_Pos)) /* Assignment of value for CPUDIV in the PM_CPUSEL register */
...
#define PM_APBASEL_APBADIV(value)             (PM_APBASEL_APBADIV_Msk & (_UINT8_(value) << PM_APBASEL_APBADIV_Pos)) /* Assignment of value for APBADIV in the PM_APBASEL register */
...
#define PM_APBBSEL_APBBDIV(value)             (PM_APBBSEL_APBBDIV_Msk & (_UINT8_(value) << PM_APBBSEL_APBBDIV_Pos)) /* Assignment of value for APBBDIV in the PM_APBBSEL register */
...
#define PM_APBCSEL_APBCDIV(value)             (PM_APBCSEL_APBCDIV_Msk & (_UINT8_(value) << PM_APBCSEL_APBCDIV_Pos)) /* Assignment of value for APBCDIV in the PM_APBCSEL register */
...
#define PM_AHBMASK_HPB0(value)                (PM_AHBMASK_HPB0_Msk & (_UINT32_(value) << PM_AHBMASK_HPB0_Pos)) /* Assignment of value for HPB0 in the PM_AHBMASK register */
...
#define PM_AHBMASK_HPB1(value)                (PM_AHBMASK_HPB1_Msk & (_UINT32_(value) << PM_AHBMASK_HPB1_Pos)) /* Assignment of value for HPB1 in the PM_AHBMASK register */
...
#define PM_AHBMASK_HPB2(value)                (PM_AHBMASK_HPB2_Msk & (_UINT32_(value) << PM_AHBMASK_HPB2_Pos)) /* Assignment of value for HPB2 in the PM_AHBMASK register */
...
#define PM_AHBMASK_DSU(value)                 (PM_AHBMASK_DSU_Msk & (_UINT32_(value) << PM_AHBMASK_DSU_Pos)) /* Assignment of value for DSU in the PM_AHBMASK register */
...
#define PM_AHBMASK_NVMCTRL(value)             (PM_AHBMASK_NVMCTRL_Msk & (_UINT32_(value) << PM_AHBMASK_NVMCTRL_Pos)) /* Assignment of value for NVMCTRL in the PM_AHBMASK register */
...
#define PM_AHBMASK_DMAC(value)                (PM_AHBMASK_DMAC_Msk & (_UINT32_(value) << PM_AHBMASK_DMAC_Pos)) /* Assignment of value for DMAC in the PM_AHBMASK register */
#define PM_AHBMASK_USB_Pos                    _UINT32_(6)                                          /* (PM_AHBMASK) USB AHB Clock Mask Position */
#define PM_AHBMASK_USB_Msk                    (_UINT32_(0x1) << PM_AHBMASK_USB_Pos)                /* (PM_AHBMASK) USB AHB Clock Mask Mask */
#define PM_AHBMASK_USB(value)                 (PM_AHBMASK_USB_Msk & (_UINT32_(value) << PM_AHBMASK_USB_Pos)) /* Assignment of value for USB in the PM_AHBMASK register */
#define PM_AHBMASK_Msk                        _UINT32_(0x0000007F)                                 /* (PM_AHBMASK) Register Mask  */
...
#define PM_APBAMASK_PAC0(value)               (PM_APBAMASK_PAC0_Msk & (_UINT32_(value) << PM_APBAMASK_PAC0_Pos)) /* Assignment of value for PAC0 in the PM_APBAMASK register */
...
#define PM_APBAMASK_PM(value)                 (PM_APBAMASK_PM_Msk & (_UINT32_(value) << PM_APBAMASK_PM_Pos)) /* Assignment of value for PM in the PM_APBAMASK register */
...
#define PM_APBAMASK_SYSCTRL(value)            (PM_APBAMASK_SYSCTRL_Msk & (_UINT32_(value) << PM_APBAMASK_SYSCTRL_Pos)) /* Assignment of value for SYSCTRL in the PM_APBAMASK register */
...
#define PM_APBAMASK_GCLK(value)               (PM_APBAMASK_GCLK_Msk & (_UINT32_(value) << PM_APBAMASK_GCLK_Pos)) /* Assignment of value for GCLK in the PM_APBAMASK register */
...
#define PM_APBAMASK_WDT(value)                (PM_APBAMASK_WDT_Msk & (_UINT32_(value) << PM_APBAMASK_WDT_Pos)) /* Assignment of value for WDT in the PM_APBAMASK register */
...
#define PM_APBAMASK_RTC(value)                (PM_APBAMASK_RTC_Msk & (_UINT32_(value) << PM_APBAMASK_RTC_Pos)) /* Assignment of value for RTC in the PM_APBAMASK register */
...
#define PM_APBAMASK_EIC(value)                (PM_APBAMASK_EIC_Msk & (_UINT32_(value) << PM_APBAMASK_EIC_Pos)) /* Assignment of value for EIC in the PM_APBAMASK register */
...
#define PM_APBBMASK_PAC1(value)               (PM_APBBMASK_PAC1_Msk & (_UINT32_(value) << PM_APBBMASK_PAC1_Pos)) /* Assignment of value for PAC1 in the PM_APBBMASK register */
...
#define PM_APBBMASK_DSU(value)                (PM_APBBMASK_DSU_Msk & (_UINT32_(value) << PM_APBBMASK_DSU_Pos)) /* Assignment of value for DSU in the PM_APBBMASK register */
...
#define PM_APBBMASK_NVMCTRL(value)            (PM_APBBMASK_NVMCTRL_Msk & (_UINT32_(value) << PM_APBBMASK_NVMCTRL_Pos)) /* Assignment of value for NVMCTRL in the PM_APBBMASK register */
...
#define PM_APBBMASK_PORT(value)               (PM_APBBMASK_PORT_Msk & (_UINT32_(value) << PM_APBBMASK_PORT_Pos)) /* Assignment of value for PORT in the PM_APBBMASK register */
...
#define PM_APBBMASK_DMAC(value)               (PM_APBBMASK_DMAC_Msk & (_UINT32_(value) << PM_APBBMASK_DMAC_Pos)) /* Assignment of value for DMAC in the PM_APBBMASK register */
#define PM_APBBMASK_USB_Pos                   _UINT32_(5)                                          /* (PM_APBBMASK) USB APB Clock Enable Position */
#define PM_APBBMASK_USB_Msk                   (_UINT32_(0x1) << PM_APBBMASK_USB_Pos)               /* (PM_APBBMASK) USB APB Clock Enable Mask */
#define PM_APBBMASK_USB(value)                (PM_APBBMASK_USB_Msk & (_UINT32_(value) << PM_APBBMASK_USB_Pos)) /* Assignment of value for USB in the PM_APBBMASK register */
...
#define PM_APBBMASK_HMATRIX(value)            (PM_APBBMASK_HMATRIX_Msk & (_UINT32_(value) << PM_APBBMASK_HMATRIX_Pos)) /* Assignment of value for HMATRIX in the PM_APBBMASK register */
#define PM_APBBMASK_Msk                       _UINT32_(0x0000007F)                                 /* (PM_APBBMASK) Register Mask  */
...
#define PM_APBCMASK_PAC2(value)               (PM_APBCMASK_PAC2_Msk & (_UINT32_(value) << PM_APBCMASK_PAC2_Pos)) /* Assignment of value for PAC2 in the PM_APBCMASK register */
...
#define PM_APBCMASK_EVSYS(value)              (PM_APBCMASK_EVSYS_Msk & (_UINT32_(value) << PM_APBCMASK_EVSYS_Pos)) /* Assignment of value for EVSYS in the PM_APBCMASK register */
...
#define PM_APBCMASK_SERCOM0(value)            (PM_APBCMASK_SERCOM0_Msk & (_UINT32_(value) << PM_APBCMASK_SERCOM0_Pos)) /* Assignment of value for SERCOM0 in the PM_APBCMASK register */
...
#define PM_APBCMASK_SERCOM1(value)            (PM_APBCMASK_SERCOM1_Msk & (_UINT32_(value) << PM_APBCMASK_SERCOM1_Pos)) /* Assignment of value for SERCOM1 in the PM_APBCMASK register */
...
#define PM_APBCMASK_SERCOM2(value)            (PM_APBCMASK_SERCOM2_Msk & (_UINT32_(value) << PM_APBCMASK_SERCOM2_Pos)) /* Assignment of value for SERCOM2 in the PM_APBCMASK register */
...
#define PM_APBCMASK_SERCOM3(value)            (PM_APBCMASK_SERCOM3_Msk & (_UINT32_(value) << PM_APBCMASK_SERCOM3_Pos)) /* Assignment of value for SERCOM3 in the PM_APBCMASK register */
...
#define PM_APBCMASK_SERCOM4(value)            (PM_APBCMASK_SERCOM4_Msk & (_UINT32_(value) << PM_APBCMASK_SERCOM4_Pos)) /* Assignment of value for SERCOM4 in the PM_APBCMASK register */
...
#define PM_APBCMASK_SERCOM5(value)            (PM_APBCMASK_SERCOM5_Msk & (_UINT32_(value) << PM_APBCMASK_SERCOM5_Pos)) /* Assignment of value for SERCOM5 in the PM_APBCMASK register */
...
#define PM_APBCMASK_TCC0(value)               (PM_APBCMASK_TCC0_Msk & (_UINT32_(value) << PM_APBCMASK_TCC0_Pos)) /* Assignment of value for TCC0 in the PM_APBCMASK register */
...
#define PM_APBCMASK_TCC1(value)               (PM_APBCMASK_TCC1_Msk & (_UINT32_(value) << PM_APBCMASK_TCC1_Pos)) /* Assignment of value for TCC1 in the PM_APBCMASK register */
...
#define PM_APBCMASK_TCC2(value)               (PM_APBCMASK_TCC2_Msk & (_UINT32_(value) << PM_APBCMASK_TCC2_Pos)) /* Assignment of value for TCC2 in the PM_APBCMASK register */
...
#define PM_APBCMASK_TC3(value)                (PM_APBCMASK_TC3_Msk & (_UINT32_(value) << PM_APBCMASK_TC3_Pos)) /* Assignment of value for TC3 in the PM_APBCMASK register */
...
#define PM_APBCMASK_TC4(value)                (PM_APBCMASK_TC4_Msk & (_UINT32_(value) << PM_APBCMASK_TC4_Pos)) /* Assignment of value for TC4 in the PM_APBCMASK register */
...
#define PM_APBCMASK_TC5(value)                (PM_APBCMASK_TC5_Msk & (_UINT32_(value) << PM_APBCMASK_TC5_Pos)) /* Assignment of value for TC5 in the PM_APBCMASK register */
...
#define PM_APBCMASK_TC6(value)                (PM_APBCMASK_TC6_Msk & (_UINT32_(value) << PM_APBCMASK_TC6_Pos)) /* Assignment of value for TC6 in the PM_APBCMASK register */
...
#define PM_APBCMASK_TC7(value)                (PM_APBCMASK_TC7_Msk & (_UINT32_(value) << PM_APBCMASK_TC7_Pos)) /* Assignment of value for TC7 in the PM_APBCMASK register */
...
#define PM_APBCMASK_ADC(value)                (PM_APBCMASK_ADC_Msk & (_UINT32_(value) << PM_APBCMASK_ADC_Pos)) /* Assignment of value for ADC in the PM_APBCMASK register */
...
#define PM_APBCMASK_AC(value)                 (PM_APBCMASK_AC_Msk & (_UINT32_(value) << PM_APBCMASK_AC_Pos)) /* Assignment of value for AC in the PM_APBCMASK register */
...
#define PM_APBCMASK_DAC(value)                (PM_APBCMASK_DAC_Msk & (_UINT32_(value) << PM_APBCMASK_DAC_Pos)) /* Assignment of value for DAC in the PM_APBCMASK register */
...
#define PM_APBCMASK_PTC(value)                (PM_APBCMASK_PTC_Msk & (_UINT32_(value) << PM_APBCMASK_PTC_Pos)) /* Assignment of value for PTC in the PM_APBCMASK register */
#define PM_APBCMASK_I2S_Pos                   _UINT32_(20)                                         /* (PM_APBCMASK) I2S APB Clock Enable Position */
#define PM_APBCMASK_I2S_Msk                   (_UINT32_(0x1) << PM_APBCMASK_I2S_Pos)               /* (PM_APBCMASK) I2S APB Clock Enable Mask */
#define PM_APBCMASK_I2S(value)                (PM_APBCMASK_I2S_Msk & (_UINT32_(value) << PM_APBCMASK_I2S_Pos)) /* Assignment of value for I2S in the PM_APBCMASK register */
#define PM_APBCMASK_TCC3_Pos                  _UINT32_(24)                                         /* (PM_APBCMASK) TCC3 APB Clock Enable Position */
#define PM_APBCMASK_TCC3_Msk                  (_UINT32_(0x1) << PM_APBCMASK_TCC3_Pos)              /* (PM_APBCMASK) TCC3 APB Clock Enable Mask */
#define PM_APBCMASK_TCC3(value)               (PM_APBCMASK_TCC3_Msk & (_UINT32_(value) << PM_APBCMASK_TCC3_Pos)) /* Assignment of value for TCC3 in the PM_APBCMASK register */
#define PM_APBCMASK_Msk                       _UINT32_(0x011FFFFF)                                 /* (PM_APBCMASK) Register Mask  */
...
#define PM_INTENCLR_CKRDY(value)              (PM_INTENCLR_CKRDY_Msk & (_UINT8_(value) << PM_INTENCLR_CKRDY_Pos)) /* Assignment of value for CKRDY in the PM_INTENCLR register */
...
#define PM_INTENSET_CKRDY(value)              (PM_INTENSET_CKRDY_Msk & (_UINT8_(value) << PM_INTENSET_CKRDY_Pos)) /* Assignment of value for CKRDY in the PM_INTENSET register */
...
#define PM_INTFLAG_CKRDY(value)               (PM_INTFLAG_CKRDY_Msk & (_UINT8_(value) << PM_INTFLAG_CKRDY_Pos)) /* Assignment of value for CKRDY in the PM_INTFLAG register */
...
#define PM_RCAUSE_POR(value)                  (PM_RCAUSE_POR_Msk & (_UINT8_(value) << PM_RCAUSE_POR_Pos)) /* Assignment of value for POR in the PM_RCAUSE register */
...
#define PM_RCAUSE_BOD12(value)                (PM_RCAUSE_BOD12_Msk & (_UINT8_(value) << PM_RCAUSE_BOD12_Pos)) /* Assignment of value for BOD12 in the PM_RCAUSE register */
...
#define PM_RCAUSE_BOD33(value)                (PM_RCAUSE_BOD33_Msk & (_UINT8_(value) << PM_RCAUSE_BOD33_Pos)) /* Assignment of value for BOD33 in the PM_RCAUSE register */
...
#define PM_RCAUSE_EXT(value)                  (PM_RCAUSE_EXT_Msk & (_UINT8_(value) << PM_RCAUSE_EXT_Pos)) /* Assignment of value for EXT in the PM_RCAUSE register */
...
#define PM_RCAUSE_WDT(value)                  (PM_RCAUSE_WDT_Msk & (_UINT8_(value) << PM_RCAUSE_WDT_Pos)) /* Assignment of value for WDT in the PM_RCAUSE register */
...
#define PM_RCAUSE_SYST(value)                 (PM_RCAUSE_SYST_Msk & (_UINT8_(value) << PM_RCAUSE_SYST_Pos)) /* Assignment of value for SYST in the PM_RCAUSE register */
