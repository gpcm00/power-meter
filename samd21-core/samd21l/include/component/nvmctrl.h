...
#define NVMCTRL_PARAM_RWWEEP(value)           (NVMCTRL_PARAM_RWWEEP_Msk & (_UINT32_(value) << NVMCTRL_PARAM_RWWEEP_Pos)) /* Assignment of value for RWWEEP in the NVMCTRL_PARAM register */
