...
#define PM_APBCMASK_AC1_Pos                   _UINT32_(21)                                         /* (PM_APBCMASK) AC1 APB Clock Enable Position */
#define PM_APBCMASK_AC1_Msk                   (_UINT32_(0x1) << PM_APBCMASK_AC1_Pos)               /* (PM_APBCMASK) AC1 APB Clock Enable Mask */
#define PM_APBCMASK_AC1(value)                (PM_APBCMASK_AC1_Msk & (_UINT32_(value) << PM_APBCMASK_AC1_Pos)) /* Assignment of value for AC1 in the PM_APBCMASK register */
...
#define PM_APBCMASK_Msk                       _UINT32_(0x0127FFFF)                                 /* (PM_APBCMASK) Register Mask  */
