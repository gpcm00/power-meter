...
def onShowPropsDFP2(t):
    ...
    if (architecture.count("M23") or architecture.count("M33")):
...
def _begin_communication_session():    
    global comm_iface, comm_speed, erase_as_needed , connect_mode
...
def jlink_connect(iface,speed):
    try:
        ...
        log.info("JLinkConnect, device=" +d)
...
def _begin_programming_operation():
    global erase_as_needed, connect_mode
    erase_as_needed = True
