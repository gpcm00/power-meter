...
#define MTB_PID4_REG_OFST              _UINT32_(0xFD0)     /* (MTB_PID4) CoreSight Offset */
#define MTB_PID5_REG_OFST              _UINT32_(0xFD4)     /* (MTB_PID5) CoreSight Offset */
#define MTB_PID6_REG_OFST              _UINT32_(0xFD8)     /* (MTB_PID6) CoreSight Offset */
#define MTB_PID7_REG_OFST              _UINT32_(0xFDC)     /* (MTB_PID7) CoreSight Offset */
#define MTB_PID0_REG_OFST              _UINT32_(0xFE0)     /* (MTB_PID0) CoreSight Offset */
#define MTB_PID1_REG_OFST              _UINT32_(0xFE4)     /* (MTB_PID1) CoreSight Offset */
#define MTB_PID2_REG_OFST              _UINT32_(0xFE8)     /* (MTB_PID2) CoreSight Offset */
#define MTB_PID3_REG_OFST              _UINT32_(0xFEC)     /* (MTB_PID3) CoreSight Offset */
#define MTB_CID0_REG_OFST              _UINT32_(0xFF0)     /* (MTB_CID0) CoreSight Offset */
#define MTB_CID1_REG_OFST              _UINT32_(0xFF4)     /* (MTB_CID1) CoreSight Offset */
#define MTB_CID2_REG_OFST              _UINT32_(0xFF8)     /* (MTB_CID2) CoreSight Offset */
#define MTB_CID3_REG_OFST              _UINT32_(0xFFC)     /* (MTB_CID3) CoreSight Offset */
