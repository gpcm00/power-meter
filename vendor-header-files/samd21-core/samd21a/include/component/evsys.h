...
#define EVSYS_CTRL_SWRST(value)               (EVSYS_CTRL_SWRST_Msk & (_UINT8_(value) << EVSYS_CTRL_SWRST_Pos)) /* Assignment of value for SWRST in the EVSYS_CTRL register */
...
#define EVSYS_CTRL_GCLKREQ(value)             (EVSYS_CTRL_GCLKREQ_Msk & (_UINT8_(value) << EVSYS_CTRL_GCLKREQ_Pos)) /* Assignment of value for GCLKREQ in the EVSYS_CTRL register */
...
#define EVSYS_CHANNEL_CHANNEL(value)          (EVSYS_CHANNEL_CHANNEL_Msk & (_UINT32_(value) << EVSYS_CHANNEL_CHANNEL_Pos)) /* Assignment of value for CHANNEL in the EVSYS_CHANNEL register */
...
#define EVSYS_CHANNEL_SWEVT(value)            (EVSYS_CHANNEL_SWEVT_Msk & (_UINT32_(value) << EVSYS_CHANNEL_SWEVT_Pos)) /* Assignment of value for SWEVT in the EVSYS_CHANNEL register */
...
#define EVSYS_USER_USER_Msk                   (_UINT16_(0x1F) << EVSYS_USER_USER_Pos)              /* (EVSYS_USER) User Multiplexer Selection Mask */
#define EVSYS_USER_USER(value)                (EVSYS_USER_USER_Msk & (_UINT16_(value) << EVSYS_USER_USER_Pos)) /* Assignment of value for USER in the EVSYS_USER register */
...
#define EVSYS_USER_CHANNEL(value)             (EVSYS_USER_CHANNEL_Msk & (_UINT16_(value) << EVSYS_USER_CHANNEL_Pos)) /* Assignment of value for CHANNEL in the EVSYS_USER register */
...
#define EVSYS_USER_Msk                        _UINT16_(0x1F1F)                                     /* (EVSYS_USER) Register Mask  */
...
#define EVSYS_CHSTATUS_USRRDY4(value)         (EVSYS_CHSTATUS_USRRDY4_Msk & (_UINT32_(value) << EVSYS_CHSTATUS_USRRDY4_Pos)) /* Assignment of value for USRRDY4 in the EVSYS_CHSTATUS register */
...
#define EVSYS_CHSTATUS_USRRDY5(value)         (EVSYS_CHSTATUS_USRRDY5_Msk & (_UINT32_(value) << EVSYS_CHSTATUS_USRRDY5_Pos)) /* Assignment of value for USRRDY5 in the EVSYS_CHSTATUS register */
...
#define EVSYS_CHSTATUS_USRRDY6(value)         (EVSYS_CHSTATUS_USRRDY6_Msk & (_UINT32_(value) << EVSYS_CHSTATUS_USRRDY6_Pos)) /* Assignment of value for USRRDY6 in the EVSYS_CHSTATUS register */
...
#define EVSYS_CHSTATUS_USRRDY7(value)         (EVSYS_CHSTATUS_USRRDY7_Msk & (_UINT32_(value) << EVSYS_CHSTATUS_USRRDY7_Pos)) /* Assignment of value for USRRDY7 in the EVSYS_CHSTATUS register */
...
#define EVSYS_CHSTATUS_CHBUSY4(value)         (EVSYS_CHSTATUS_CHBUSY4_Msk & (_UINT32_(value) << EVSYS_CHSTATUS_CHBUSY4_Pos)) /* Assignment of value for CHBUSY4 in the EVSYS_CHSTATUS register */
...
#define EVSYS_CHSTATUS_CHBUSY5(value)         (EVSYS_CHSTATUS_CHBUSY5_Msk & (_UINT32_(value) << EVSYS_CHSTATUS_CHBUSY5_Pos)) /* Assignment of value for CHBUSY5 in the EVSYS_CHSTATUS register */
...
#define EVSYS_CHSTATUS_CHBUSY6(value)         (EVSYS_CHSTATUS_CHBUSY6_Msk & (_UINT32_(value) << EVSYS_CHSTATUS_CHBUSY6_Pos)) /* Assignment of value for CHBUSY6 in the EVSYS_CHSTATUS register */
...
#define EVSYS_CHSTATUS_CHBUSY7(value)         (EVSYS_CHSTATUS_CHBUSY7_Msk & (_UINT32_(value) << EVSYS_CHSTATUS_CHBUSY7_Pos)) /* Assignment of value for CHBUSY7 in the EVSYS_CHSTATUS register */
...
#define EVSYS_CHSTATUS_USRRDY8(value)         (EVSYS_CHSTATUS_USRRDY8_Msk & (_UINT32_(value) << EVSYS_CHSTATUS_USRRDY8_Pos)) /* Assignment of value for USRRDY8 in the EVSYS_CHSTATUS register */
...
#define EVSYS_CHSTATUS_USRRDY9(value)         (EVSYS_CHSTATUS_USRRDY9_Msk & (_UINT32_(value) << EVSYS_CHSTATUS_USRRDY9_Pos)) /* Assignment of value for USRRDY9 in the EVSYS_CHSTATUS register */
...
#define EVSYS_CHSTATUS_USRRDY10(value)        (EVSYS_CHSTATUS_USRRDY10_Msk & (_UINT32_(value) << EVSYS_CHSTATUS_USRRDY10_Pos)) /* Assignment of value for USRRDY10 in the EVSYS_CHSTATUS register */
...
#define EVSYS_CHSTATUS_USRRDY11(value)        (EVSYS_CHSTATUS_USRRDY11_Msk & (_UINT32_(value) << EVSYS_CHSTATUS_USRRDY11_Pos)) /* Assignment of value for USRRDY11 in the EVSYS_CHSTATUS register */
...
#define EVSYS_CHSTATUS_CHBUSY8(value)         (EVSYS_CHSTATUS_CHBUSY8_Msk & (_UINT32_(value) << EVSYS_CHSTATUS_CHBUSY8_Pos)) /* Assignment of value for CHBUSY8 in the EVSYS_CHSTATUS register */
...
#define EVSYS_CHSTATUS_CHBUSY9(value)         (EVSYS_CHSTATUS_CHBUSY9_Msk & (_UINT32_(value) << EVSYS_CHSTATUS_CHBUSY9_Pos)) /* Assignment of value for CHBUSY9 in the EVSYS_CHSTATUS register */
...
#define EVSYS_CHSTATUS_CHBUSY10(value)        (EVSYS_CHSTATUS_CHBUSY10_Msk & (_UINT32_(value) << EVSYS_CHSTATUS_CHBUSY10_Pos)) /* Assignment of value for CHBUSY10 in the EVSYS_CHSTATUS register */
...
#define EVSYS_CHSTATUS_CHBUSY11(value)        (EVSYS_CHSTATUS_CHBUSY11_Msk & (_UINT32_(value) << EVSYS_CHSTATUS_CHBUSY11_Pos)) /* Assignment of value for CHBUSY11 in the EVSYS_CHSTATUS register */
...
#define EVSYS_INTENCLR_OVR4(value)            (EVSYS_INTENCLR_OVR4_Msk & (_UINT32_(value) << EVSYS_INTENCLR_OVR4_Pos)) /* Assignment of value for OVR4 in the EVSYS_INTENCLR register */
...
#define EVSYS_INTENCLR_OVR5(value)            (EVSYS_INTENCLR_OVR5_Msk & (_UINT32_(value) << EVSYS_INTENCLR_OVR5_Pos)) /* Assignment of value for OVR5 in the EVSYS_INTENCLR register */
...
#define EVSYS_INTENCLR_OVR6(value)            (EVSYS_INTENCLR_OVR6_Msk & (_UINT32_(value) << EVSYS_INTENCLR_OVR6_Pos)) /* Assignment of value for OVR6 in the EVSYS_INTENCLR register */
...
#define EVSYS_INTENCLR_OVR7(value)            (EVSYS_INTENCLR_OVR7_Msk & (_UINT32_(value) << EVSYS_INTENCLR_OVR7_Pos)) /* Assignment of value for OVR7 in the EVSYS_INTENCLR register */
...
#define EVSYS_INTENCLR_EVD4(value)            (EVSYS_INTENCLR_EVD4_Msk & (_UINT32_(value) << EVSYS_INTENCLR_EVD4_Pos)) /* Assignment of value for EVD4 in the EVSYS_INTENCLR register */
...
#define EVSYS_INTENCLR_EVD5(value)            (EVSYS_INTENCLR_EVD5_Msk & (_UINT32_(value) << EVSYS_INTENCLR_EVD5_Pos)) /* Assignment of value for EVD5 in the EVSYS_INTENCLR register */
...
#define EVSYS_INTENCLR_EVD6(value)            (EVSYS_INTENCLR_EVD6_Msk & (_UINT32_(value) << EVSYS_INTENCLR_EVD6_Pos)) /* Assignment of value for EVD6 in the EVSYS_INTENCLR register */
...
#define EVSYS_INTENCLR_EVD7(value)            (EVSYS_INTENCLR_EVD7_Msk & (_UINT32_(value) << EVSYS_INTENCLR_EVD7_Pos)) /* Assignment of value for EVD7 in the EVSYS_INTENCLR register */
...
#define EVSYS_INTENCLR_OVR8(value)            (EVSYS_INTENCLR_OVR8_Msk & (_UINT32_(value) << EVSYS_INTENCLR_OVR8_Pos)) /* Assignment of value for OVR8 in the EVSYS_INTENCLR register */
...
#define EVSYS_INTENCLR_OVR9(value)            (EVSYS_INTENCLR_OVR9_Msk & (_UINT32_(value) << EVSYS_INTENCLR_OVR9_Pos)) /* Assignment of value for OVR9 in the EVSYS_INTENCLR register */
...
#define EVSYS_INTENCLR_OVR10(value)           (EVSYS_INTENCLR_OVR10_Msk & (_UINT32_(value) << EVSYS_INTENCLR_OVR10_Pos)) /* Assignment of value for OVR10 in the EVSYS_INTENCLR register */
...
#define EVSYS_INTENCLR_OVR11(value)           (EVSYS_INTENCLR_OVR11_Msk & (_UINT32_(value) << EVSYS_INTENCLR_OVR11_Pos)) /* Assignment of value for OVR11 in the EVSYS_INTENCLR register */
...
#define EVSYS_INTENCLR_EVD8(value)            (EVSYS_INTENCLR_EVD8_Msk & (_UINT32_(value) << EVSYS_INTENCLR_EVD8_Pos)) /* Assignment of value for EVD8 in the EVSYS_INTENCLR register */
...
#define EVSYS_INTENCLR_EVD9(value)            (EVSYS_INTENCLR_EVD9_Msk & (_UINT32_(value) << EVSYS_INTENCLR_EVD9_Pos)) /* Assignment of value for EVD9 in the EVSYS_INTENCLR register */
...
#define EVSYS_INTENCLR_EVD10(value)           (EVSYS_INTENCLR_EVD10_Msk & (_UINT32_(value) << EVSYS_INTENCLR_EVD10_Pos)) /* Assignment of value for EVD10 in the EVSYS_INTENCLR register */
...
#define EVSYS_INTENCLR_EVD11(value)           (EVSYS_INTENCLR_EVD11_Msk & (_UINT32_(value) << EVSYS_INTENCLR_EVD11_Pos)) /* Assignment of value for EVD11 in the EVSYS_INTENCLR register */
...
#define EVSYS_INTENSET_OVR4(value)            (EVSYS_INTENSET_OVR4_Msk & (_UINT32_(value) << EVSYS_INTENSET_OVR4_Pos)) /* Assignment of value for OVR4 in the EVSYS_INTENSET register */
...
#define EVSYS_INTENSET_OVR5(value)            (EVSYS_INTENSET_OVR5_Msk & (_UINT32_(value) << EVSYS_INTENSET_OVR5_Pos)) /* Assignment of value for OVR5 in the EVSYS_INTENSET register */
...
#define EVSYS_INTENSET_OVR6(value)            (EVSYS_INTENSET_OVR6_Msk & (_UINT32_(value) << EVSYS_INTENSET_OVR6_Pos)) /* Assignment of value for OVR6 in the EVSYS_INTENSET register */
...
#define EVSYS_INTENSET_OVR7(value)            (EVSYS_INTENSET_OVR7_Msk & (_UINT32_(value) << EVSYS_INTENSET_OVR7_Pos)) /* Assignment of value for OVR7 in the EVSYS_INTENSET register */
...
#define EVSYS_INTENSET_EVD4(value)            (EVSYS_INTENSET_EVD4_Msk & (_UINT32_(value) << EVSYS_INTENSET_EVD4_Pos)) /* Assignment of value for EVD4 in the EVSYS_INTENSET register */
...
#define EVSYS_INTENSET_EVD5(value)            (EVSYS_INTENSET_EVD5_Msk & (_UINT32_(value) << EVSYS_INTENSET_EVD5_Pos)) /* Assignment of value for EVD5 in the EVSYS_INTENSET register */
...
#define EVSYS_INTENSET_EVD6(value)            (EVSYS_INTENSET_EVD6_Msk & (_UINT32_(value) << EVSYS_INTENSET_EVD6_Pos)) /* Assignment of value for EVD6 in the EVSYS_INTENSET register */
...
#define EVSYS_INTENSET_EVD7(value)            (EVSYS_INTENSET_EVD7_Msk & (_UINT32_(value) << EVSYS_INTENSET_EVD7_Pos)) /* Assignment of value for EVD7 in the EVSYS_INTENSET register */
...
#define EVSYS_INTENSET_OVR8(value)            (EVSYS_INTENSET_OVR8_Msk & (_UINT32_(value) << EVSYS_INTENSET_OVR8_Pos)) /* Assignment of value for OVR8 in the EVSYS_INTENSET register */
...
#define EVSYS_INTENSET_OVR9(value)            (EVSYS_INTENSET_OVR9_Msk & (_UINT32_(value) << EVSYS_INTENSET_OVR9_Pos)) /* Assignment of value for OVR9 in the EVSYS_INTENSET register */
...
#define EVSYS_INTENSET_OVR10(value)           (EVSYS_INTENSET_OVR10_Msk & (_UINT32_(value) << EVSYS_INTENSET_OVR10_Pos)) /* Assignment of value for OVR10 in the EVSYS_INTENSET register */
...
#define EVSYS_INTENSET_OVR11(value)           (EVSYS_INTENSET_OVR11_Msk & (_UINT32_(value) << EVSYS_INTENSET_OVR11_Pos)) /* Assignment of value for OVR11 in the EVSYS_INTENSET register */
...
#define EVSYS_INTENSET_EVD8(value)            (EVSYS_INTENSET_EVD8_Msk & (_UINT32_(value) << EVSYS_INTENSET_EVD8_Pos)) /* Assignment of value for EVD8 in the EVSYS_INTENSET register */
...
#define EVSYS_INTENSET_EVD9(value)            (EVSYS_INTENSET_EVD9_Msk & (_UINT32_(value) << EVSYS_INTENSET_EVD9_Pos)) /* Assignment of value for EVD9 in the EVSYS_INTENSET register */
...
#define EVSYS_INTENSET_EVD10(value)           (EVSYS_INTENSET_EVD10_Msk & (_UINT32_(value) << EVSYS_INTENSET_EVD10_Pos)) /* Assignment of value for EVD10 in the EVSYS_INTENSET register */
...
#define EVSYS_INTENSET_EVD11(value)           (EVSYS_INTENSET_EVD11_Msk & (_UINT32_(value) << EVSYS_INTENSET_EVD11_Pos)) /* Assignment of value for EVD11 in the EVSYS_INTENSET register */
...
#define EVSYS_INTFLAG_OVR4(value)             (EVSYS_INTFLAG_OVR4_Msk & (_UINT32_(value) << EVSYS_INTFLAG_OVR4_Pos)) /* Assignment of value for OVR4 in the EVSYS_INTFLAG register */
...
#define EVSYS_INTFLAG_OVR5(value)             (EVSYS_INTFLAG_OVR5_Msk & (_UINT32_(value) << EVSYS_INTFLAG_OVR5_Pos)) /* Assignment of value for OVR5 in the EVSYS_INTFLAG register */
...
#define EVSYS_INTFLAG_OVR6(value)             (EVSYS_INTFLAG_OVR6_Msk & (_UINT32_(value) << EVSYS_INTFLAG_OVR6_Pos)) /* Assignment of value for OVR6 in the EVSYS_INTFLAG register */
...
#define EVSYS_INTFLAG_OVR7(value)             (EVSYS_INTFLAG_OVR7_Msk & (_UINT32_(value) << EVSYS_INTFLAG_OVR7_Pos)) /* Assignment of value for OVR7 in the EVSYS_INTFLAG register */
...
#define EVSYS_INTFLAG_EVD4(value)             (EVSYS_INTFLAG_EVD4_Msk & (_UINT32_(value) << EVSYS_INTFLAG_EVD4_Pos)) /* Assignment of value for EVD4 in the EVSYS_INTFLAG register */
...
#define EVSYS_INTFLAG_EVD5(value)             (EVSYS_INTFLAG_EVD5_Msk & (_UINT32_(value) << EVSYS_INTFLAG_EVD5_Pos)) /* Assignment of value for EVD5 in the EVSYS_INTFLAG register */
...
#define EVSYS_INTFLAG_EVD6(value)             (EVSYS_INTFLAG_EVD6_Msk & (_UINT32_(value) << EVSYS_INTFLAG_EVD6_Pos)) /* Assignment of value for EVD6 in the EVSYS_INTFLAG register */
...
#define EVSYS_INTFLAG_EVD7(value)             (EVSYS_INTFLAG_EVD7_Msk & (_UINT32_(value) << EVSYS_INTFLAG_EVD7_Pos)) /* Assignment of value for EVD7 in the EVSYS_INTFLAG register */
...
#define EVSYS_INTFLAG_OVR8(value)             (EVSYS_INTFLAG_OVR8_Msk & (_UINT32_(value) << EVSYS_INTFLAG_OVR8_Pos)) /* Assignment of value for OVR8 in the EVSYS_INTFLAG register */
...
#define EVSYS_INTFLAG_OVR9(value)             (EVSYS_INTFLAG_OVR9_Msk & (_UINT32_(value) << EVSYS_INTFLAG_OVR9_Pos)) /* Assignment of value for OVR9 in the EVSYS_INTFLAG register */
...
#define EVSYS_INTFLAG_OVR10(value)            (EVSYS_INTFLAG_OVR10_Msk & (_UINT32_(value) << EVSYS_INTFLAG_OVR10_Pos)) /* Assignment of value for OVR10 in the EVSYS_INTFLAG register */
...
#define EVSYS_INTFLAG_OVR11(value)            (EVSYS_INTFLAG_OVR11_Msk & (_UINT32_(value) << EVSYS_INTFLAG_OVR11_Pos)) /* Assignment of value for OVR11 in the EVSYS_INTFLAG register */
...
#define EVSYS_INTFLAG_EVD8(value)             (EVSYS_INTFLAG_EVD8_Msk & (_UINT32_(value) << EVSYS_INTFLAG_EVD8_Pos)) /* Assignment of value for EVD8 in the EVSYS_INTFLAG register */
...
#define EVSYS_INTFLAG_EVD9(value)             (EVSYS_INTFLAG_EVD9_Msk & (_UINT32_(value) << EVSYS_INTFLAG_EVD9_Pos)) /* Assignment of value for EVD9 in the EVSYS_INTFLAG register */
...
#define EVSYS_INTFLAG_EVD10(value)            (EVSYS_INTFLAG_EVD10_Msk & (_UINT32_(value) << EVSYS_INTFLAG_EVD10_Pos)) /* Assignment of value for EVD10 in the EVSYS_INTFLAG register */
...
#define EVSYS_INTFLAG_EVD11(value)            (EVSYS_INTFLAG_EVD11_Msk & (_UINT32_(value) << EVSYS_INTFLAG_EVD11_Pos)) /* Assignment of value for EVD11 in the EVSYS_INTFLAG register */
