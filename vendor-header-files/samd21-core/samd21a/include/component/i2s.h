...
#define I2S_CTRLA_SEREN0_Pos                  _UINT8_(4)                                           /* (I2S_CTRLA) Serializer 0 Enable Position */
#define I2S_CTRLA_SEREN0_Msk                  (_UINT8_(0x1) << I2S_CTRLA_SEREN0_Pos)               /* (I2S_CTRLA) Serializer 0 Enable Mask */
#define I2S_CTRLA_SEREN0(value)               (I2S_CTRLA_SEREN0_Msk & (_UINT8_(value) << I2S_CTRLA_SEREN0_Pos)) /* Assignment of value for SEREN0 in the I2S_CTRLA register */
#define I2S_CTRLA_SEREN1_Pos                  _UINT8_(5)                                           /* (I2S_CTRLA) Serializer 1 Enable Position */
#define I2S_CTRLA_SEREN1_Msk                  (_UINT8_(0x1) << I2S_CTRLA_SEREN1_Pos)               /* (I2S_CTRLA) Serializer 1 Enable Mask */
#define I2S_CTRLA_SEREN1(value)               (I2S_CTRLA_SEREN1_Msk & (_UINT8_(value) << I2S_CTRLA_SEREN1_Pos)) /* Assignment of value for SEREN1 in the I2S_CTRLA register */
...
#define I2S_CTRLA_SEREN_Pos                   _UINT8_(4)                                           /* (I2S_CTRLA Position) Serializer x Enable */
#define I2S_CTRLA_SEREN_Msk                   (_UINT8_(0x3) << I2S_CTRLA_SEREN_Pos)                /* (I2S_CTRLA Mask) SEREN */
#define I2S_CTRLA_SEREN(value)                (I2S_CTRLA_SEREN_Msk & (_UINT8_(value) << I2S_CTRLA_SEREN_Pos)) 
...
#define I2S_CLKCTRL_FSINV_Pos                 _UINT32_(11)                                         /* (I2S_CLKCTRL) Frame Sync Invert Position */
...
#define I2S_CLKCTRL_SCKSEL_Pos                _UINT32_(12)                                         /* (I2S_CLKCTRL) Serial Clock Select Position */
...
#define I2S_CLKCTRL_MCKSEL_Pos                _UINT32_(16)                                         /* (I2S_CLKCTRL) Master Clock Select Position */
...
#define I2S_CLKCTRL_MCKEN_Pos                 _UINT32_(18)                                         /* (I2S_CLKCTRL) Master Clock Enable Position */
...
#define I2S_CLKCTRL_MCKDIV_Pos                _UINT32_(19)                                         /* (I2S_CLKCTRL) Master Clock Division Factor Position */
#define I2S_CLKCTRL_MCKDIV_Msk                (_UINT32_(0x1F) << I2S_CLKCTRL_MCKDIV_Pos)           /* (I2S_CLKCTRL) Master Clock Division Factor Mask */
...
#define I2S_CLKCTRL_MCKOUTDIV_Msk             (_UINT32_(0x1F) << I2S_CLKCTRL_MCKOUTDIV_Pos)        /* (I2S_CLKCTRL) Master Clock Output Division Factor Mask */
...
#define I2S_CLKCTRL_FSOUTINV_Pos              _UINT32_(29)                                         /* (I2S_CLKCTRL) Frame Sync Output Invert Position */
...
#define I2S_CLKCTRL_SCKOUTINV_Pos             _UINT32_(30)                                         /* (I2S_CLKCTRL) Serial Clock Output Invert Position */
...
#define I2S_CLKCTRL_MCKOUTINV_Pos             _UINT32_(31)                                         /* (I2S_CLKCTRL) Master Clock Output Invert Position */
...
#define I2S_CLKCTRL_Msk                       _UINT32_(0xFFFD19FF)                                 /* (I2S_CLKCTRL) Register Mask  */
...
#define I2S_SYNCBUSY_SEREN0_Pos               _UINT16_(4)                                          /* (I2S_SYNCBUSY) Serializer 0 Enable Synchronization Status Position */
#define I2S_SYNCBUSY_SEREN0_Msk               (_UINT16_(0x1) << I2S_SYNCBUSY_SEREN0_Pos)           /* (I2S_SYNCBUSY) Serializer 0 Enable Synchronization Status Mask */
#define I2S_SYNCBUSY_SEREN0(value)            (I2S_SYNCBUSY_SEREN0_Msk & (_UINT16_(value) << I2S_SYNCBUSY_SEREN0_Pos)) /* Assignment of value for SEREN0 in the I2S_SYNCBUSY register */
#define I2S_SYNCBUSY_SEREN1_Pos               _UINT16_(5)                                          /* (I2S_SYNCBUSY) Serializer 1 Enable Synchronization Status Position */
#define I2S_SYNCBUSY_SEREN1_Msk               (_UINT16_(0x1) << I2S_SYNCBUSY_SEREN1_Pos)           /* (I2S_SYNCBUSY) Serializer 1 Enable Synchronization Status Mask */
#define I2S_SYNCBUSY_SEREN1(value)            (I2S_SYNCBUSY_SEREN1_Msk & (_UINT16_(value) << I2S_SYNCBUSY_SEREN1_Pos)) /* Assignment of value for SEREN1 in the I2S_SYNCBUSY register */
#define I2S_SYNCBUSY_DATA0_Pos                _UINT16_(8)                                          /* (I2S_SYNCBUSY) Data 0 Synchronization Status Position */
#define I2S_SYNCBUSY_DATA0_Msk                (_UINT16_(0x1) << I2S_SYNCBUSY_DATA0_Pos)            /* (I2S_SYNCBUSY) Data 0 Synchronization Status Mask */
#define I2S_SYNCBUSY_DATA0(value)             (I2S_SYNCBUSY_DATA0_Msk & (_UINT16_(value) << I2S_SYNCBUSY_DATA0_Pos)) /* Assignment of value for DATA0 in the I2S_SYNCBUSY register */
#define I2S_SYNCBUSY_DATA1_Pos                _UINT16_(9)                                          /* (I2S_SYNCBUSY) Data 1 Synchronization Status Position */
#define I2S_SYNCBUSY_DATA1_Msk                (_UINT16_(0x1) << I2S_SYNCBUSY_DATA1_Pos)            /* (I2S_SYNCBUSY) Data 1 Synchronization Status Mask */
#define I2S_SYNCBUSY_DATA1(value)             (I2S_SYNCBUSY_DATA1_Msk & (_UINT16_(value) << I2S_SYNCBUSY_DATA1_Pos)) /* Assignment of value for DATA1 in the I2S_SYNCBUSY register */
...
#define I2S_SYNCBUSY_SEREN_Pos                _UINT16_(4)                                          /* (I2S_SYNCBUSY Position) Serializer x Enable Synchronization Status */
#define I2S_SYNCBUSY_SEREN_Msk                (_UINT16_(0x3) << I2S_SYNCBUSY_SEREN_Pos)            /* (I2S_SYNCBUSY Mask) SEREN */
#define I2S_SYNCBUSY_SEREN(value)             (I2S_SYNCBUSY_SEREN_Msk & (_UINT16_(value) << I2S_SYNCBUSY_SEREN_Pos)) 
#define I2S_SYNCBUSY_DATA_Pos                 _UINT16_(8)                                          /* (I2S_SYNCBUSY Position) Data x Synchronization Status */
#define I2S_SYNCBUSY_DATA_Msk                 (_UINT16_(0x3) << I2S_SYNCBUSY_DATA_Pos)             /* (I2S_SYNCBUSY Mask) DATA */
#define I2S_SYNCBUSY_DATA(value)              (I2S_SYNCBUSY_DATA_Msk & (_UINT16_(value) << I2S_SYNCBUSY_DATA_Pos)) 

/* -------- I2S_SERCTRL : (I2S Offset: 0x20) (R/W 32) Serializer n Control -------- */
#define I2S_SERCTRL_RESETVALUE                _UINT32_(0x00)                                       /*  (I2S_SERCTRL) Serializer n Control  Reset Value */

#define I2S_SERCTRL_SERMODE_Pos               _UINT32_(0)                                          /* (I2S_SERCTRL) Serializer Mode Position */
#define I2S_SERCTRL_SERMODE_Msk               (_UINT32_(0x3) << I2S_SERCTRL_SERMODE_Pos)           /* (I2S_SERCTRL) Serializer Mode Mask */
#define I2S_SERCTRL_SERMODE(value)            (I2S_SERCTRL_SERMODE_Msk & (_UINT32_(value) << I2S_SERCTRL_SERMODE_Pos)) /* Assignment of value for SERMODE in the I2S_SERCTRL register */
#define   I2S_SERCTRL_SERMODE_RX_Val          _UINT32_(0x0)                                        /* (I2S_SERCTRL) Receive  */
#define   I2S_SERCTRL_SERMODE_TX_Val          _UINT32_(0x1)                                        /* (I2S_SERCTRL) Transmit  */
#define   I2S_SERCTRL_SERMODE_PDM2_Val        _UINT32_(0x2)                                        /* (I2S_SERCTRL) Receive one PDM data on each serial clock edge  */
...
#define I2S_SERCTRL_TXDEFAULT_Pos             _UINT32_(2)                                          /* (I2S_SERCTRL) Line Default Line when Slot Disabled Position */
#define I2S_SERCTRL_TXDEFAULT_Msk             (_UINT32_(0x3) << I2S_SERCTRL_TXDEFAULT_Pos)         /* (I2S_SERCTRL) Line Default Line when Slot Disabled Mask */
#define I2S_SERCTRL_TXDEFAULT(value)          (I2S_SERCTRL_TXDEFAULT_Msk & (_UINT32_(value) << I2S_SERCTRL_TXDEFAULT_Pos)) /* Assignment of value for TXDEFAULT in the I2S_SERCTRL register */
#define   I2S_SERCTRL_TXDEFAULT_ZERO_Val      _UINT32_(0x0)                                        /* (I2S_SERCTRL) Output Default Value is 0  */
#define   I2S_SERCTRL_TXDEFAULT_ONE_Val       _UINT32_(0x1)                                        /* (I2S_SERCTRL) Output Default Value is 1  */
#define   I2S_SERCTRL_TXDEFAULT_HIZ_Val       _UINT32_(0x3)                                        /* (I2S_SERCTRL) Output Default Value is high impedance  */
...
#define I2S_SERCTRL_TXSAME_Pos                _UINT32_(4)                                          /* (I2S_SERCTRL) Transmit Data when Underrun Position */
#define I2S_SERCTRL_TXSAME_Msk                (_UINT32_(0x1) << I2S_SERCTRL_TXSAME_Pos)            /* (I2S_SERCTRL) Transmit Data when Underrun Mask */
#define I2S_SERCTRL_TXSAME(value)             (I2S_SERCTRL_TXSAME_Msk & (_UINT32_(value) << I2S_SERCTRL_TXSAME_Pos)) /* Assignment of value for TXSAME in the I2S_SERCTRL register */
#define   I2S_SERCTRL_TXSAME_ZERO_Val         _UINT32_(0x0)                                        /* (I2S_SERCTRL) Zero data transmitted in case of underrun  */
#define   I2S_SERCTRL_TXSAME_SAME_Val         _UINT32_(0x1)                                        /* (I2S_SERCTRL) Last data transmitted in case of underrun  */
...
#define I2S_SERCTRL_CLKSEL_Pos                _UINT32_(5)                                          /* (I2S_SERCTRL) Clock Unit Selection Position */
#define I2S_SERCTRL_CLKSEL_Msk                (_UINT32_(0x1) << I2S_SERCTRL_CLKSEL_Pos)            /* (I2S_SERCTRL) Clock Unit Selection Mask */
#define I2S_SERCTRL_CLKSEL(value)             (I2S_SERCTRL_CLKSEL_Msk & (_UINT32_(value) << I2S_SERCTRL_CLKSEL_Pos)) /* Assignment of value for CLKSEL in the I2S_SERCTRL register */
#define   I2S_SERCTRL_CLKSEL_CLK0_Val         _UINT32_(0x0)                                        /* (I2S_SERCTRL) Use Clock Unit 0  */
#define   I2S_SERCTRL_CLKSEL_CLK1_Val         _UINT32_(0x1)                                        /* (I2S_SERCTRL) Use Clock Unit 1  */
...
#define I2S_SERCTRL_SLOTADJ_Pos               _UINT32_(7)                                          /* (I2S_SERCTRL) Data Slot Formatting Adjust Position */
#define I2S_SERCTRL_SLOTADJ_Msk               (_UINT32_(0x1) << I2S_SERCTRL_SLOTADJ_Pos)           /* (I2S_SERCTRL) Data Slot Formatting Adjust Mask */
#define I2S_SERCTRL_SLOTADJ(value)            (I2S_SERCTRL_SLOTADJ_Msk & (_UINT32_(value) << I2S_SERCTRL_SLOTADJ_Pos)) /* Assignment of value for SLOTADJ in the I2S_SERCTRL register */
#define   I2S_SERCTRL_SLOTADJ_RIGHT_Val       _UINT32_(0x0)                                        /* (I2S_SERCTRL) Data is right adjusted in slot  */
#define   I2S_SERCTRL_SLOTADJ_LEFT_Val        _UINT32_(0x1)                                        /* (I2S_SERCTRL) Data is left adjusted in slot  */
...
#define I2S_SERCTRL_DATASIZE_Pos              _UINT32_(8)                                          /* (I2S_SERCTRL) Data Word Size Position */
#define I2S_SERCTRL_DATASIZE_Msk              (_UINT32_(0x7) << I2S_SERCTRL_DATASIZE_Pos)          /* (I2S_SERCTRL) Data Word Size Mask */
#define I2S_SERCTRL_DATASIZE(value)           (I2S_SERCTRL_DATASIZE_Msk & (_UINT32_(value) << I2S_SERCTRL_DATASIZE_Pos)) /* Assignment of value for DATASIZE in the I2S_SERCTRL register */
#define   I2S_SERCTRL_DATASIZE_32_Val         _UINT32_(0x0)                                        /* (I2S_SERCTRL) 32 bits  */
#define   I2S_SERCTRL_DATASIZE_24_Val         _UINT32_(0x1)                                        /* (I2S_SERCTRL) 24 bits  */
#define   I2S_SERCTRL_DATASIZE_20_Val         _UINT32_(0x2)                                        /* (I2S_SERCTRL) 20 bits  */
#define   I2S_SERCTRL_DATASIZE_18_Val         _UINT32_(0x3)                                        /* (I2S_SERCTRL) 18 bits  */
#define   I2S_SERCTRL_DATASIZE_16_Val         _UINT32_(0x4)                                        /* (I2S_SERCTRL) 16 bits  */
#define   I2S_SERCTRL_DATASIZE_16C_Val        _UINT32_(0x5)                                        /* (I2S_SERCTRL) 16 bits compact stereo  */
#define   I2S_SERCTRL_DATASIZE_8_Val          _UINT32_(0x6)                                        /* (I2S_SERCTRL) 8 bits  */
#define   I2S_SERCTRL_DATASIZE_8C_Val         _UINT32_(0x7)                                        /* (I2S_SERCTRL) 8 bits compact stereo  */
...
#define I2S_SERCTRL_WORDADJ_Pos               _UINT32_(12)                                         /* (I2S_SERCTRL) Data Word Formatting Adjust Position */
#define I2S_SERCTRL_WORDADJ_Msk               (_UINT32_(0x1) << I2S_SERCTRL_WORDADJ_Pos)           /* (I2S_SERCTRL) Data Word Formatting Adjust Mask */
#define I2S_SERCTRL_WORDADJ(value)            (I2S_SERCTRL_WORDADJ_Msk & (_UINT32_(value) << I2S_SERCTRL_WORDADJ_Pos)) /* Assignment of value for WORDADJ in the I2S_SERCTRL register */
#define   I2S_SERCTRL_WORDADJ_RIGHT_Val       _UINT32_(0x0)                                        /* (I2S_SERCTRL) Data is right adjusted in word  */
#define   I2S_SERCTRL_WORDADJ_LEFT_Val        _UINT32_(0x1)                                        /* (I2S_SERCTRL) Data is left adjusted in word  */
...
#define I2S_SERCTRL_EXTEND_Pos                _UINT32_(13)                                         /* (I2S_SERCTRL) Data Formatting Bit Extension Position */
#define I2S_SERCTRL_EXTEND_Msk                (_UINT32_(0x3) << I2S_SERCTRL_EXTEND_Pos)            /* (I2S_SERCTRL) Data Formatting Bit Extension Mask */
#define I2S_SERCTRL_EXTEND(value)             (I2S_SERCTRL_EXTEND_Msk & (_UINT32_(value) << I2S_SERCTRL_EXTEND_Pos)) /* Assignment of value for EXTEND in the I2S_SERCTRL register */
#define   I2S_SERCTRL_EXTEND_ZERO_Val         _UINT32_(0x0)                                        /* (I2S_SERCTRL) Extend with zeroes  */
#define   I2S_SERCTRL_EXTEND_ONE_Val          _UINT32_(0x1)                                        /* (I2S_SERCTRL) Extend with ones  */
#define   I2S_SERCTRL_EXTEND_MSBIT_Val        _UINT32_(0x2)                                        /* (I2S_SERCTRL) Extend with Most Significant Bit  */
#define   I2S_SERCTRL_EXTEND_LSBIT_Val        _UINT32_(0x3)                                        /* (I2S_SERCTRL) Extend with Least Significant Bit  */
...
#define I2S_SERCTRL_BITREV_Pos                _UINT32_(15)                                         /* (I2S_SERCTRL) Data Formatting Bit Reverse Position */
#define I2S_SERCTRL_BITREV_Msk                (_UINT32_(0x1) << I2S_SERCTRL_BITREV_Pos)            /* (I2S_SERCTRL) Data Formatting Bit Reverse Mask */
#define I2S_SERCTRL_BITREV(value)             (I2S_SERCTRL_BITREV_Msk & (_UINT32_(value) << I2S_SERCTRL_BITREV_Pos)) /* Assignment of value for BITREV in the I2S_SERCTRL register */
#define   I2S_SERCTRL_BITREV_MSBIT_Val        _UINT32_(0x0)                                        /* (I2S_SERCTRL) Transfer Data Most Significant Bit (MSB) first (default for I2S protocol)  */
#define   I2S_SERCTRL_BITREV_LSBIT_Val        _UINT32_(0x1)                                        /* (I2S_SERCTRL) Transfer Data Least Significant Bit (LSB) first  */
...
#define I2S_SERCTRL_SLOTDIS0_Pos              _UINT32_(16)                                         /* (I2S_SERCTRL) Slot 0 Disabled for this Serializer Position */
#define I2S_SERCTRL_SLOTDIS0_Msk              (_UINT32_(0x1) << I2S_SERCTRL_SLOTDIS0_Pos)          /* (I2S_SERCTRL) Slot 0 Disabled for this Serializer Mask */
#define I2S_SERCTRL_SLOTDIS0(value)           (I2S_SERCTRL_SLOTDIS0_Msk & (_UINT32_(value) << I2S_SERCTRL_SLOTDIS0_Pos)) /* Assignment of value for SLOTDIS0 in the I2S_SERCTRL register */
#define I2S_SERCTRL_SLOTDIS1_Pos              _UINT32_(17)                                         /* (I2S_SERCTRL) Slot 1 Disabled for this Serializer Position */
#define I2S_SERCTRL_SLOTDIS1_Msk              (_UINT32_(0x1) << I2S_SERCTRL_SLOTDIS1_Pos)          /* (I2S_SERCTRL) Slot 1 Disabled for this Serializer Mask */
#define I2S_SERCTRL_SLOTDIS1(value)           (I2S_SERCTRL_SLOTDIS1_Msk & (_UINT32_(value) << I2S_SERCTRL_SLOTDIS1_Pos)) /* Assignment of value for SLOTDIS1 in the I2S_SERCTRL register */
#define I2S_SERCTRL_SLOTDIS2_Pos              _UINT32_(18)                                         /* (I2S_SERCTRL) Slot 2 Disabled for this Serializer Position */
#define I2S_SERCTRL_SLOTDIS2_Msk              (_UINT32_(0x1) << I2S_SERCTRL_SLOTDIS2_Pos)          /* (I2S_SERCTRL) Slot 2 Disabled for this Serializer Mask */
#define I2S_SERCTRL_SLOTDIS2(value)           (I2S_SERCTRL_SLOTDIS2_Msk & (_UINT32_(value) << I2S_SERCTRL_SLOTDIS2_Pos)) /* Assignment of value for SLOTDIS2 in the I2S_SERCTRL register */
#define I2S_SERCTRL_SLOTDIS3_Pos              _UINT32_(19)                                         /* (I2S_SERCTRL) Slot 3 Disabled for this Serializer Position */
#define I2S_SERCTRL_SLOTDIS3_Msk              (_UINT32_(0x1) << I2S_SERCTRL_SLOTDIS3_Pos)          /* (I2S_SERCTRL) Slot 3 Disabled for this Serializer Mask */
#define I2S_SERCTRL_SLOTDIS3(value)           (I2S_SERCTRL_SLOTDIS3_Msk & (_UINT32_(value) << I2S_SERCTRL_SLOTDIS3_Pos)) /* Assignment of value for SLOTDIS3 in the I2S_SERCTRL register */
#define I2S_SERCTRL_SLOTDIS4_Pos              _UINT32_(20)                                         /* (I2S_SERCTRL) Slot 4 Disabled for this Serializer Position */
#define I2S_SERCTRL_SLOTDIS4_Msk              (_UINT32_(0x1) << I2S_SERCTRL_SLOTDIS4_Pos)          /* (I2S_SERCTRL) Slot 4 Disabled for this Serializer Mask */
#define I2S_SERCTRL_SLOTDIS4(value)           (I2S_SERCTRL_SLOTDIS4_Msk & (_UINT32_(value) << I2S_SERCTRL_SLOTDIS4_Pos)) /* Assignment of value for SLOTDIS4 in the I2S_SERCTRL register */
#define I2S_SERCTRL_SLOTDIS5_Pos              _UINT32_(21)                                         /* (I2S_SERCTRL) Slot 5 Disabled for this Serializer Position */
#define I2S_SERCTRL_SLOTDIS5_Msk              (_UINT32_(0x1) << I2S_SERCTRL_SLOTDIS5_Pos)          /* (I2S_SERCTRL) Slot 5 Disabled for this Serializer Mask */
#define I2S_SERCTRL_SLOTDIS5(value)           (I2S_SERCTRL_SLOTDIS5_Msk & (_UINT32_(value) << I2S_SERCTRL_SLOTDIS5_Pos)) /* Assignment of value for SLOTDIS5 in the I2S_SERCTRL register */
#define I2S_SERCTRL_SLOTDIS6_Pos              _UINT32_(22)                                         /* (I2S_SERCTRL) Slot 6 Disabled for this Serializer Position */
#define I2S_SERCTRL_SLOTDIS6_Msk              (_UINT32_(0x1) << I2S_SERCTRL_SLOTDIS6_Pos)          /* (I2S_SERCTRL) Slot 6 Disabled for this Serializer Mask */
#define I2S_SERCTRL_SLOTDIS6(value)           (I2S_SERCTRL_SLOTDIS6_Msk & (_UINT32_(value) << I2S_SERCTRL_SLOTDIS6_Pos)) /* Assignment of value for SLOTDIS6 in the I2S_SERCTRL register */
#define I2S_SERCTRL_SLOTDIS7_Pos              _UINT32_(23)                                         /* (I2S_SERCTRL) Slot 7 Disabled for this Serializer Position */
#define I2S_SERCTRL_SLOTDIS7_Msk              (_UINT32_(0x1) << I2S_SERCTRL_SLOTDIS7_Pos)          /* (I2S_SERCTRL) Slot 7 Disabled for this Serializer Mask */
#define I2S_SERCTRL_SLOTDIS7(value)           (I2S_SERCTRL_SLOTDIS7_Msk & (_UINT32_(value) << I2S_SERCTRL_SLOTDIS7_Pos)) /* Assignment of value for SLOTDIS7 in the I2S_SERCTRL register */
#define I2S_SERCTRL_MONO_Pos                  _UINT32_(24)                                         /* (I2S_SERCTRL) Mono Mode Position */
#define I2S_SERCTRL_MONO_Msk                  (_UINT32_(0x1) << I2S_SERCTRL_MONO_Pos)              /* (I2S_SERCTRL) Mono Mode Mask */
#define I2S_SERCTRL_MONO(value)               (I2S_SERCTRL_MONO_Msk & (_UINT32_(value) << I2S_SERCTRL_MONO_Pos)) /* Assignment of value for MONO in the I2S_SERCTRL register */
#define   I2S_SERCTRL_MONO_STEREO_Val         _UINT32_(0x0)                                        /* (I2S_SERCTRL) Normal mode  */
#define   I2S_SERCTRL_MONO_MONO_Val           _UINT32_(0x1)                                        /* (I2S_SERCTRL) Left channel data is duplicated to right channel  */
...
#define I2S_SERCTRL_DMA_Pos                   _UINT32_(25)                                         /* (I2S_SERCTRL) Single or Multiple DMA Channels Position */
#define I2S_SERCTRL_DMA_Msk                   (_UINT32_(0x1) << I2S_SERCTRL_DMA_Pos)               /* (I2S_SERCTRL) Single or Multiple DMA Channels Mask */
#define I2S_SERCTRL_DMA(value)                (I2S_SERCTRL_DMA_Msk & (_UINT32_(value) << I2S_SERCTRL_DMA_Pos)) /* Assignment of value for DMA in the I2S_SERCTRL register */
#define   I2S_SERCTRL_DMA_SINGLE_Val          _UINT32_(0x0)                                        /* (I2S_SERCTRL) Single DMA channel  */
#define   I2S_SERCTRL_DMA_MULTIPLE_Val        _UINT32_(0x1)                                        /* (I2S_SERCTRL) One DMA channel per data channel  */
...
#define I2S_SERCTRL_RXLOOP_Pos                _UINT32_(26)                                         /* (I2S_SERCTRL) Loop-back Test Mode Position */
#define I2S_SERCTRL_RXLOOP_Msk                (_UINT32_(0x1) << I2S_SERCTRL_RXLOOP_Pos)            /* (I2S_SERCTRL) Loop-back Test Mode Mask */
#define I2S_SERCTRL_RXLOOP(value)             (I2S_SERCTRL_RXLOOP_Msk & (_UINT32_(value) << I2S_SERCTRL_RXLOOP_Pos)) /* Assignment of value for RXLOOP in the I2S_SERCTRL register */
#define I2S_SERCTRL_Msk                       _UINT32_(0x07FFF7BF)                                 /* (I2S_SERCTRL) Register Mask  */

#define I2S_SERCTRL_SLOTDIS_Pos               _UINT32_(16)                                         /* (I2S_SERCTRL Position) Slot x Disabled for this Serializer */
#define I2S_SERCTRL_SLOTDIS_Msk               (_UINT32_(0xFF) << I2S_SERCTRL_SLOTDIS_Pos)          /* (I2S_SERCTRL Mask) SLOTDIS */
#define I2S_SERCTRL_SLOTDIS(value)            (I2S_SERCTRL_SLOTDIS_Msk & (_UINT32_(value) << I2S_SERCTRL_SLOTDIS_Pos)) 

/* -------- I2S_DATA : (I2S Offset: 0x30) (R/W 32) Data n -------- */
#define I2S_DATA_RESETVALUE                   _UINT32_(0x00)                                       /*  (I2S_DATA) Data n  Reset Value */

#define I2S_DATA_DATA_Pos                     _UINT32_(0)                                          /* (I2S_DATA) Sample Data Position */
#define I2S_DATA_DATA_Msk                     (_UINT32_(0xFFFFFFFF) << I2S_DATA_DATA_Pos)          /* (I2S_DATA) Sample Data Mask */
#define I2S_DATA_DATA(value)                  (I2S_DATA_DATA_Msk & (_UINT32_(value) << I2S_DATA_DATA_Pos)) /* Assignment of value for DATA in the I2S_DATA register */
#define I2S_DATA_Msk                          _UINT32_(0xFFFFFFFF)                                 /* (I2S_DATA) Register Mask  */
...
#define I2S_SERCTRL_REG_OFST           _UINT32_(0x20)      /* (I2S_SERCTRL) Serializer n Control Offset */
#define I2S_SERCTRL0_REG_OFST          _UINT32_(0x20)      /* (I2S_SERCTRL0) Serializer n Control Offset */
#define I2S_SERCTRL1_REG_OFST          _UINT32_(0x24)      /* (I2S_SERCTRL1) Serializer n Control Offset */
#define I2S_DATA_REG_OFST              _UINT32_(0x30)      /* (I2S_DATA) Data n Offset */
#define I2S_DATA0_REG_OFST             _UINT32_(0x30)      /* (I2S_DATA0) Data n Offset */
#define I2S_DATA1_REG_OFST             _UINT32_(0x34)      /* (I2S_DATA1) Data n Offset */
