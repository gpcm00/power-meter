...
#define WDT_CTRL_RESETVALUE                   _UINT8_(0x00)                                        /*  (WDT_CTRL) Control  Reset Value */

#define WDT_CTRL_ENABLE_Pos                   _UINT8_(1)                                           /* (WDT_CTRL) Enable Position */
#define WDT_CTRL_ENABLE_Msk                   (_UINT8_(0x1) << WDT_CTRL_ENABLE_Pos)                /* (WDT_CTRL) Enable Mask */
#define WDT_CTRL_ENABLE(value)                (WDT_CTRL_ENABLE_Msk & (_UINT8_(value) << WDT_CTRL_ENABLE_Pos)) /* Assignment of value for ENABLE in the WDT_CTRL register */
#define WDT_CTRL_WEN_Pos                      _UINT8_(2)                                           /* (WDT_CTRL) Watchdog Timer Window Mode Enable Position */
#define WDT_CTRL_WEN_Msk                      (_UINT8_(0x1) << WDT_CTRL_WEN_Pos)                   /* (WDT_CTRL) Watchdog Timer Window Mode Enable Mask */
#define WDT_CTRL_WEN(value)                   (WDT_CTRL_WEN_Msk & (_UINT8_(value) << WDT_CTRL_WEN_Pos)) /* Assignment of value for WEN in the WDT_CTRL register */
#define WDT_CTRL_ALWAYSON_Pos                 _UINT8_(7)                                           /* (WDT_CTRL) Always-On Position */
#define WDT_CTRL_ALWAYSON_Msk                 (_UINT8_(0x1) << WDT_CTRL_ALWAYSON_Pos)              /* (WDT_CTRL) Always-On Mask */
#define WDT_CTRL_ALWAYSON(value)              (WDT_CTRL_ALWAYSON_Msk & (_UINT8_(value) << WDT_CTRL_ALWAYSON_Pos)) /* Assignment of value for ALWAYSON in the WDT_CTRL register */
#define WDT_CTRL_Msk                          _UINT8_(0x86)                                        /* (WDT_CTRL) Register Mask  */
...
#define   WDT_CONFIG_PER_8_Val                _UINT8_(0x0)                                         /* (WDT_CONFIG) 8 clock cycles  */
#define   WDT_CONFIG_PER_16_Val               _UINT8_(0x1)                                         /* (WDT_CONFIG) 16 clock cycles  */
#define   WDT_CONFIG_PER_32_Val               _UINT8_(0x2)                                         /* (WDT_CONFIG) 32 clock cycles  */
#define   WDT_CONFIG_PER_64_Val               _UINT8_(0x3)                                         /* (WDT_CONFIG) 64 clock cycles  */
#define   WDT_CONFIG_PER_128_Val              _UINT8_(0x4)                                         /* (WDT_CONFIG) 128 clock cycles  */
#define   WDT_CONFIG_PER_256_Val              _UINT8_(0x5)                                         /* (WDT_CONFIG) 256 clock cycles  */
#define   WDT_CONFIG_PER_512_Val              _UINT8_(0x6)                                         /* (WDT_CONFIG) 512 clock cycles  */
#define   WDT_CONFIG_PER_1K_Val               _UINT8_(0x7)                                         /* (WDT_CONFIG) 1024 clock cycles  */
#define   WDT_CONFIG_PER_2K_Val               _UINT8_(0x8)                                         /* (WDT_CONFIG) 2048 clock cycles  */
#define   WDT_CONFIG_PER_4K_Val               _UINT8_(0x9)                                         /* (WDT_CONFIG) 4096 clock cycles  */
#define   WDT_CONFIG_PER_8K_Val               _UINT8_(0xA)                                         /* (WDT_CONFIG) 8192 clock cycles  */
#define   WDT_CONFIG_PER_16K_Val              _UINT8_(0xB)                                         /* (WDT_CONFIG) 16384 clock cycles  */
...
#define   WDT_CONFIG_WINDOW_8_Val             _UINT8_(0x0)                                         /* (WDT_CONFIG) 8 clock cycles  */
#define   WDT_CONFIG_WINDOW_16_Val            _UINT8_(0x1)                                         /* (WDT_CONFIG) 16 clock cycles  */
#define   WDT_CONFIG_WINDOW_32_Val            _UINT8_(0x2)                                         /* (WDT_CONFIG) 32 clock cycles  */
#define   WDT_CONFIG_WINDOW_64_Val            _UINT8_(0x3)                                         /* (WDT_CONFIG) 64 clock cycles  */
#define   WDT_CONFIG_WINDOW_128_Val           _UINT8_(0x4)                                         /* (WDT_CONFIG) 128 clock cycles  */
#define   WDT_CONFIG_WINDOW_256_Val           _UINT8_(0x5)                                         /* (WDT_CONFIG) 256 clock cycles  */
#define   WDT_CONFIG_WINDOW_512_Val           _UINT8_(0x6)                                         /* (WDT_CONFIG) 512 clock cycles  */
#define   WDT_CONFIG_WINDOW_1K_Val            _UINT8_(0x7)                                         /* (WDT_CONFIG) 1024 clock cycles  */
#define   WDT_CONFIG_WINDOW_2K_Val            _UINT8_(0x8)                                         /* (WDT_CONFIG) 2048 clock cycles  */
#define   WDT_CONFIG_WINDOW_4K_Val            _UINT8_(0x9)                                         /* (WDT_CONFIG) 4096 clock cycles  */
#define   WDT_CONFIG_WINDOW_8K_Val            _UINT8_(0xA)                                         /* (WDT_CONFIG) 8192 clock cycles  */
#define   WDT_CONFIG_WINDOW_16K_Val           _UINT8_(0xB)                                         /* (WDT_CONFIG) 16384 clock cycles  */
...
#define   WDT_EWCTRL_EWOFFSET_8_Val           _UINT8_(0x0)                                         /* (WDT_EWCTRL) 8 clock cycles  */
#define   WDT_EWCTRL_EWOFFSET_16_Val          _UINT8_(0x1)                                         /* (WDT_EWCTRL) 16 clock cycles  */
#define   WDT_EWCTRL_EWOFFSET_32_Val          _UINT8_(0x2)                                         /* (WDT_EWCTRL) 32 clock cycles  */
#define   WDT_EWCTRL_EWOFFSET_64_Val          _UINT8_(0x3)                                         /* (WDT_EWCTRL) 64 clock cycles  */
#define   WDT_EWCTRL_EWOFFSET_128_Val         _UINT8_(0x4)                                         /* (WDT_EWCTRL) 128 clock cycles  */
#define   WDT_EWCTRL_EWOFFSET_256_Val         _UINT8_(0x5)                                         /* (WDT_EWCTRL) 256 clock cycles  */
#define   WDT_EWCTRL_EWOFFSET_512_Val         _UINT8_(0x6)                                         /* (WDT_EWCTRL) 512 clock cycles  */
#define   WDT_EWCTRL_EWOFFSET_1K_Val          _UINT8_(0x7)                                         /* (WDT_EWCTRL) 1024 clock cycles  */
#define   WDT_EWCTRL_EWOFFSET_2K_Val          _UINT8_(0x8)                                         /* (WDT_EWCTRL) 2048 clock cycles  */
#define   WDT_EWCTRL_EWOFFSET_4K_Val          _UINT8_(0x9)                                         /* (WDT_EWCTRL) 4096 clock cycles  */
#define   WDT_EWCTRL_EWOFFSET_8K_Val          _UINT8_(0xA)                                         /* (WDT_EWCTRL) 8192 clock cycles  */
#define   WDT_EWCTRL_EWOFFSET_16K_Val         _UINT8_(0xB)                                         /* (WDT_EWCTRL) 16384 clock cycles  */
...
#define WDT_STATUS_RESETVALUE                 _UINT8_(0x00)                                        /*  (WDT_STATUS) Status  Reset Value */

#define WDT_STATUS_SYNCBUSY_Pos               _UINT8_(7)                                           /* (WDT_STATUS) Synchronization Busy Position */
#define WDT_STATUS_SYNCBUSY_Msk               (_UINT8_(0x1) << WDT_STATUS_SYNCBUSY_Pos)            /* (WDT_STATUS) Synchronization Busy Mask */
#define WDT_STATUS_SYNCBUSY(value)            (WDT_STATUS_SYNCBUSY_Msk & (_UINT8_(value) << WDT_STATUS_SYNCBUSY_Pos)) /* Assignment of value for SYNCBUSY in the WDT_STATUS register */
#define WDT_STATUS_Msk                        _UINT8_(0x80)                                        /* (WDT_STATUS) Register Mask  */
...
#define WDT_CTRL_REG_OFST              _UINT32_(0x00)      /* (WDT_CTRL) Control Offset */
...
#define WDT_STATUS_REG_OFST            _UINT32_(0x07)      /* (WDT_STATUS) Status Offset */
#define WDT_CLEAR_REG_OFST             _UINT32_(0x08)      /* (WDT_CLEAR) Clear Offset */
