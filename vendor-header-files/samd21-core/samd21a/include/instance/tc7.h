...
#define TC7_DMAC_ID_MC0                          (37)       /* Indexes of DMA Match/Compare 0 trigger */
#define TC7_DMAC_ID_MC1                          (38)       /* Indexes of DMA Match/Compare 1 trigger */
#define TC7_DMAC_ID_OVF                          (36)       /* Indexes of DMA Overflow trigger */
#define TC7_GCLK_ID                              (29)       /* Index of Generic Clock */
#define TC7_INSTANCE_ID                          (79)
#define TC7_MASTER                               (0)
