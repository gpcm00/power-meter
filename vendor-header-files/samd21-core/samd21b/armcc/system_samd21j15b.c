/*
 * System configuration file for ATSAMD21J15B
 *
...
// Check if DeviceVectors is defined and create a typedef to VECTOR_TABLE_Type
    ...
    typedef DeviceVectors VECTOR_TABLE_Type; // Defines the toolchain agnostic type of the vector table type defined in the 'samd21j15b.h'
