...
#define PM_APBCMASK_Msk                       _UINT32_(0x001F3F3F)                                 /* (PM_APBCMASK) Register Mask  */
...
#define PM_APBCMASK_SERCOM_Msk                (_UINT32_(0xF) << PM_APBCMASK_SERCOM_Pos)            /* (PM_APBCMASK Mask) SERCOM */
...
#define PM_APBCMASK_TC_Msk                    (_UINT32_(0x7) << PM_APBCMASK_TC_Pos)                /* (PM_APBCMASK Mask) TC */
