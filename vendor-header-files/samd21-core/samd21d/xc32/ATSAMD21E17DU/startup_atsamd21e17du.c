 ...
 * \file
 *
 * \brief MPLAB(R) XC32 - Startup code for SAMD21E17DU
 *
...
void Reserved14                ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
...
void Reserved21                ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void Reserved22                ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
...
#else /* Legacy defined(_SAMD21E17DU_H) */
