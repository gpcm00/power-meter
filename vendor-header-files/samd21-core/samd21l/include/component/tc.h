...
#define TC_CTRLA_RESETVALUE                   _UINT16_(0x00)                                       /*  (TC_CTRLA) Control A  Reset Value */
...
#define   TC_CTRLA_PRESCALER_DIV8_Val         _UINT16_(0x3)                                        /* (TC_CTRLA) Prescaler: GCLK_TC/8  */
#define   TC_CTRLA_PRESCALER_DIV16_Val        _UINT16_(0x4)                                        /* (TC_CTRLA) Prescaler: GCLK_TC/16  */
...
#define TC_READREQ_RESETVALUE                 _UINT16_(0x00)                                       /*  (TC_READREQ) Read Request  Reset Value */
...
#define TC_CTRLBCLR_RESETVALUE                _UINT8_(0x02)                                        /*  (TC_CTRLBCLR) Control B Clear  Reset Value */
...
#define TC_CTRLC_RESETVALUE                   _UINT8_(0x00)                                        /*  (TC_CTRLC) Control C  Reset Value */
...
#define TC_CTRLC_INVEN_Msk                    (_UINT8_(0x3) << TC_CTRLC_INVEN_Pos)                 /* (TC_CTRLC Mask) INVEN */
#define TC_CTRLC_INVEN(value)                 (TC_CTRLC_INVEN_Msk & (_UINT8_(value) << TC_CTRLC_INVEN_Pos)) 
#define TC_CTRLC_CPTEN_Pos                    _UINT8_(4)                                           /* (TC_CTRLC Position) Capture Channel x Enable */
#define TC_CTRLC_CPTEN_Msk                    (_UINT8_(0x3) << TC_CTRLC_CPTEN_Pos)                 /* (TC_CTRLC Mask) CPTEN */
#define TC_CTRLC_CPTEN(value)                 (TC_CTRLC_CPTEN_Msk & (_UINT8_(value) << TC_CTRLC_CPTEN_Pos)) 
...
#define TC_STATUS_RESETVALUE                  _UINT8_(0x08)                                        /*  (TC_STATUS) Status  Reset Value */
...
#define TC_COUNT8_COUNT_RESETVALUE            _UINT8_(0x00)                                        /*  (TC_COUNT8_COUNT) COUNT8 Counter Value  Reset Value */
...
#define TC_COUNT16_COUNT_RESETVALUE           _UINT16_(0x00)                                       /*  (TC_COUNT16_COUNT) COUNT16 Counter Value  Reset Value */
...
#define TC_COUNT32_COUNT_RESETVALUE           _UINT32_(0x00)                                       /*  (TC_COUNT32_COUNT) COUNT32 Counter Value  Reset Value */
...
#define TC_COUNT8_PER_RESETVALUE              _UINT8_(0xFF)                                        /*  (TC_COUNT8_PER) COUNT8 Period Value  Reset Value */
...
#define TC_COUNT8_CC_RESETVALUE               _UINT8_(0x00)                                        /*  (TC_COUNT8_CC) COUNT8 Compare/Capture  Reset Value */
...
#define TC_COUNT16_CC_RESETVALUE              _UINT16_(0x00)                                       /*  (TC_COUNT16_CC) COUNT16 Compare/Capture  Reset Value */
...
#define TC_COUNT32_CC_RESETVALUE              _UINT32_(0x00)                                       /*  (TC_COUNT32_CC) COUNT32 Compare/Capture  Reset Value */
...
#define TC_CTRLC_REG_OFST              _UINT32_(0x06)      /* (TC_CTRLC) Control C Offset */
#define TC_DBGCTRL_REG_OFST            _UINT32_(0x08)      /* (TC_DBGCTRL) Debug Control Offset */
#define TC_EVCTRL_REG_OFST             _UINT32_(0x0A)      /* (TC_EVCTRL) Event Control Offset */
#define TC_INTENCLR_REG_OFST           _UINT32_(0x0C)      /* (TC_INTENCLR) Interrupt Enable Clear Offset */
#define TC_INTENSET_REG_OFST           _UINT32_(0x0D)      /* (TC_INTENSET) Interrupt Enable Set Offset */
#define TC_INTFLAG_REG_OFST            _UINT32_(0x0E)      /* (TC_INTFLAG) Interrupt Flag Status and Clear Offset */
#define TC_STATUS_REG_OFST             _UINT32_(0x0F)      /* (TC_STATUS) Status Offset */
#define TC_COUNT8_COUNT_REG_OFST       _UINT32_(0x10)      /* (TC_COUNT8_COUNT) COUNT8 Counter Value Offset */
#define TC_COUNT16_COUNT_REG_OFST      _UINT32_(0x10)      /* (TC_COUNT16_COUNT) COUNT16 Counter Value Offset */
#define TC_COUNT32_COUNT_REG_OFST      _UINT32_(0x10)      /* (TC_COUNT32_COUNT) COUNT32 Counter Value Offset */
#define TC_COUNT8_PER_REG_OFST         _UINT32_(0x14)      /* (TC_COUNT8_PER) COUNT8 Period Value Offset */
#define TC_COUNT8_CC_REG_OFST          _UINT32_(0x18)      /* (TC_COUNT8_CC) COUNT8 Compare/Capture Offset */
#define TC_COUNT8_CC0_REG_OFST         _UINT32_(0x18)      /* (TC_COUNT8_CC0) COUNT8 Compare/Capture Offset */
#define TC_COUNT8_CC1_REG_OFST         _UINT32_(0x19)      /* (TC_COUNT8_CC1) COUNT8 Compare/Capture Offset */
#define TC_COUNT16_CC_REG_OFST         _UINT32_(0x18)      /* (TC_COUNT16_CC) COUNT16 Compare/Capture Offset */
#define TC_COUNT16_CC0_REG_OFST        _UINT32_(0x18)      /* (TC_COUNT16_CC0) COUNT16 Compare/Capture Offset */
#define TC_COUNT16_CC1_REG_OFST        _UINT32_(0x1A)      /* (TC_COUNT16_CC1) COUNT16 Compare/Capture Offset */
#define TC_COUNT32_CC_REG_OFST         _UINT32_(0x18)      /* (TC_COUNT32_CC) COUNT32 Compare/Capture Offset */
#define TC_COUNT32_CC0_REG_OFST        _UINT32_(0x18)      /* (TC_COUNT32_CC0) COUNT32 Compare/Capture Offset */
