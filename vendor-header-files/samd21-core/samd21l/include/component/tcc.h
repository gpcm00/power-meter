...
/*  file generated from device description file (ATDF) version 2020-11-19T13:00:08Z  */
...
#define TCC_CTRLA_SWRST(value)                (TCC_CTRLA_SWRST_Msk & (_UINT32_(value) << TCC_CTRLA_SWRST_Pos)) /* Assignment of value for SWRST in the TCC_CTRLA register */
...
#define TCC_CTRLA_ENABLE(value)               (TCC_CTRLA_ENABLE_Msk & (_UINT32_(value) << TCC_CTRLA_ENABLE_Pos)) /* Assignment of value for ENABLE in the TCC_CTRLA register */
...
#define TCC_CTRLA_RESOLUTION(value)           (TCC_CTRLA_RESOLUTION_Msk & (_UINT32_(value) << TCC_CTRLA_RESOLUTION_Pos)) /* Assignment of value for RESOLUTION in the TCC_CTRLA register */
...
#define TCC_CTRLA_PRESCALER(value)            (TCC_CTRLA_PRESCALER_Msk & (_UINT32_(value) << TCC_CTRLA_PRESCALER_Pos)) /* Assignment of value for PRESCALER in the TCC_CTRLA register */
...
#define TCC_CTRLA_RUNSTDBY(value)             (TCC_CTRLA_RUNSTDBY_Msk & (_UINT32_(value) << TCC_CTRLA_RUNSTDBY_Pos)) /* Assignment of value for RUNSTDBY in the TCC_CTRLA register */
...
#define TCC_CTRLA_PRESCSYNC(value)            (TCC_CTRLA_PRESCSYNC_Msk & (_UINT32_(value) << TCC_CTRLA_PRESCSYNC_Pos)) /* Assignment of value for PRESCSYNC in the TCC_CTRLA register */
...
#define TCC_CTRLA_ALOCK(value)                (TCC_CTRLA_ALOCK_Msk & (_UINT32_(value) << TCC_CTRLA_ALOCK_Pos)) /* Assignment of value for ALOCK in the TCC_CTRLA register */
...
#define TCC_CTRLA_CPTEN0(value)               (TCC_CTRLA_CPTEN0_Msk & (_UINT32_(value) << TCC_CTRLA_CPTEN0_Pos)) /* Assignment of value for CPTEN0 in the TCC_CTRLA register */
...
#define TCC_CTRLA_CPTEN1(value)               (TCC_CTRLA_CPTEN1_Msk & (_UINT32_(value) << TCC_CTRLA_CPTEN1_Pos)) /* Assignment of value for CPTEN1 in the TCC_CTRLA register */
...
#define TCC_CTRLA_CPTEN2(value)               (TCC_CTRLA_CPTEN2_Msk & (_UINT32_(value) << TCC_CTRLA_CPTEN2_Pos)) /* Assignment of value for CPTEN2 in the TCC_CTRLA register */
...
#define TCC_CTRLA_CPTEN3(value)               (TCC_CTRLA_CPTEN3_Msk & (_UINT32_(value) << TCC_CTRLA_CPTEN3_Pos)) /* Assignment of value for CPTEN3 in the TCC_CTRLA register */
#define TCC_CTRLA_Msk                         _UINT32_(0x0F007F63)                                 /* (TCC_CTRLA) Register Mask  */
...
#define TCC_CTRLBCLR_DIR(value)               (TCC_CTRLBCLR_DIR_Msk & (_UINT8_(value) << TCC_CTRLBCLR_DIR_Pos)) /* Assignment of value for DIR in the TCC_CTRLBCLR register */
...
#define TCC_CTRLBCLR_LUPD(value)              (TCC_CTRLBCLR_LUPD_Msk & (_UINT8_(value) << TCC_CTRLBCLR_LUPD_Pos)) /* Assignment of value for LUPD in the TCC_CTRLBCLR register */
...
#define TCC_CTRLBCLR_ONESHOT(value)           (TCC_CTRLBCLR_ONESHOT_Msk & (_UINT8_(value) << TCC_CTRLBCLR_ONESHOT_Pos)) /* Assignment of value for ONESHOT in the TCC_CTRLBCLR register */
...
#define TCC_CTRLBCLR_IDXCMD(value)            (TCC_CTRLBCLR_IDXCMD_Msk & (_UINT8_(value) << TCC_CTRLBCLR_IDXCMD_Pos)) /* Assignment of value for IDXCMD in the TCC_CTRLBCLR register */
...
#define TCC_CTRLBCLR_CMD(value)               (TCC_CTRLBCLR_CMD_Msk & (_UINT8_(value) << TCC_CTRLBCLR_CMD_Pos)) /* Assignment of value for CMD in the TCC_CTRLBCLR register */
...
#define TCC_CTRLBSET_DIR(value)               (TCC_CTRLBSET_DIR_Msk & (_UINT8_(value) << TCC_CTRLBSET_DIR_Pos)) /* Assignment of value for DIR in the TCC_CTRLBSET register */
...
#define TCC_CTRLBSET_LUPD(value)              (TCC_CTRLBSET_LUPD_Msk & (_UINT8_(value) << TCC_CTRLBSET_LUPD_Pos)) /* Assignment of value for LUPD in the TCC_CTRLBSET register */
...
#define TCC_CTRLBSET_ONESHOT(value)           (TCC_CTRLBSET_ONESHOT_Msk & (_UINT8_(value) << TCC_CTRLBSET_ONESHOT_Pos)) /* Assignment of value for ONESHOT in the TCC_CTRLBSET register */
...
#define TCC_CTRLBSET_IDXCMD(value)            (TCC_CTRLBSET_IDXCMD_Msk & (_UINT8_(value) << TCC_CTRLBSET_IDXCMD_Pos)) /* Assignment of value for IDXCMD in the TCC_CTRLBSET register */
...
#define TCC_CTRLBSET_CMD(value)               (TCC_CTRLBSET_CMD_Msk & (_UINT8_(value) << TCC_CTRLBSET_CMD_Pos)) /* Assignment of value for CMD in the TCC_CTRLBSET register */
...
#define TCC_SYNCBUSY_SWRST(value)             (TCC_SYNCBUSY_SWRST_Msk & (_UINT32_(value) << TCC_SYNCBUSY_SWRST_Pos)) /* Assignment of value for SWRST in the TCC_SYNCBUSY register */
...
#define TCC_SYNCBUSY_ENABLE(value)            (TCC_SYNCBUSY_ENABLE_Msk & (_UINT32_(value) << TCC_SYNCBUSY_ENABLE_Pos)) /* Assignment of value for ENABLE in the TCC_SYNCBUSY register */
...
#define TCC_SYNCBUSY_CTRLB(value)             (TCC_SYNCBUSY_CTRLB_Msk & (_UINT32_(value) << TCC_SYNCBUSY_CTRLB_Pos)) /* Assignment of value for CTRLB in the TCC_SYNCBUSY register */
...
#define TCC_SYNCBUSY_STATUS(value)            (TCC_SYNCBUSY_STATUS_Msk & (_UINT32_(value) << TCC_SYNCBUSY_STATUS_Pos)) /* Assignment of value for STATUS in the TCC_SYNCBUSY register */
...
#define TCC_SYNCBUSY_COUNT(value)             (TCC_SYNCBUSY_COUNT_Msk & (_UINT32_(value) << TCC_SYNCBUSY_COUNT_Pos)) /* Assignment of value for COUNT in the TCC_SYNCBUSY register */
...
#define TCC_SYNCBUSY_PATT(value)              (TCC_SYNCBUSY_PATT_Msk & (_UINT32_(value) << TCC_SYNCBUSY_PATT_Pos)) /* Assignment of value for PATT in the TCC_SYNCBUSY register */
...
#define TCC_SYNCBUSY_WAVE(value)              (TCC_SYNCBUSY_WAVE_Msk & (_UINT32_(value) << TCC_SYNCBUSY_WAVE_Pos)) /* Assignment of value for WAVE in the TCC_SYNCBUSY register */
...
#define TCC_SYNCBUSY_PER(value)               (TCC_SYNCBUSY_PER_Msk & (_UINT32_(value) << TCC_SYNCBUSY_PER_Pos)) /* Assignment of value for PER in the TCC_SYNCBUSY register */
...
#define TCC_SYNCBUSY_CC0(value)               (TCC_SYNCBUSY_CC0_Msk & (_UINT32_(value) << TCC_SYNCBUSY_CC0_Pos)) /* Assignment of value for CC0 in the TCC_SYNCBUSY register */
...
#define TCC_SYNCBUSY_CC1(value)               (TCC_SYNCBUSY_CC1_Msk & (_UINT32_(value) << TCC_SYNCBUSY_CC1_Pos)) /* Assignment of value for CC1 in the TCC_SYNCBUSY register */
...
#define TCC_SYNCBUSY_CC2(value)               (TCC_SYNCBUSY_CC2_Msk & (_UINT32_(value) << TCC_SYNCBUSY_CC2_Pos)) /* Assignment of value for CC2 in the TCC_SYNCBUSY register */
...
#define TCC_SYNCBUSY_CC3(value)               (TCC_SYNCBUSY_CC3_Msk & (_UINT32_(value) << TCC_SYNCBUSY_CC3_Pos)) /* Assignment of value for CC3 in the TCC_SYNCBUSY register */
#define TCC_SYNCBUSY_PATTB_Pos                _UINT32_(16)                                         /* (TCC_SYNCBUSY) Pattern Buffer Busy Position */
#define TCC_SYNCBUSY_PATTB_Msk                (_UINT32_(0x1) << TCC_SYNCBUSY_PATTB_Pos)            /* (TCC_SYNCBUSY) Pattern Buffer Busy Mask */
#define TCC_SYNCBUSY_PATTB(value)             (TCC_SYNCBUSY_PATTB_Msk & (_UINT32_(value) << TCC_SYNCBUSY_PATTB_Pos)) /* Assignment of value for PATTB in the TCC_SYNCBUSY register */
#define TCC_SYNCBUSY_WAVEB_Pos                _UINT32_(17)                                         /* (TCC_SYNCBUSY) Wave Buffer Busy Position */
#define TCC_SYNCBUSY_WAVEB_Msk                (_UINT32_(0x1) << TCC_SYNCBUSY_WAVEB_Pos)            /* (TCC_SYNCBUSY) Wave Buffer Busy Mask */
#define TCC_SYNCBUSY_WAVEB(value)             (TCC_SYNCBUSY_WAVEB_Msk & (_UINT32_(value) << TCC_SYNCBUSY_WAVEB_Pos)) /* Assignment of value for WAVEB in the TCC_SYNCBUSY register */
#define TCC_SYNCBUSY_PERB_Pos                 _UINT32_(18)                                         /* (TCC_SYNCBUSY) Period Buffer Busy Position */
#define TCC_SYNCBUSY_PERB_Msk                 (_UINT32_(0x1) << TCC_SYNCBUSY_PERB_Pos)             /* (TCC_SYNCBUSY) Period Buffer Busy Mask */
#define TCC_SYNCBUSY_PERB(value)              (TCC_SYNCBUSY_PERB_Msk & (_UINT32_(value) << TCC_SYNCBUSY_PERB_Pos)) /* Assignment of value for PERB in the TCC_SYNCBUSY register */
#define TCC_SYNCBUSY_CCB0_Pos                 _UINT32_(19)                                         /* (TCC_SYNCBUSY) Compare Channel Buffer 0 Busy Position */
#define TCC_SYNCBUSY_CCB0_Msk                 (_UINT32_(0x1) << TCC_SYNCBUSY_CCB0_Pos)             /* (TCC_SYNCBUSY) Compare Channel Buffer 0 Busy Mask */
#define TCC_SYNCBUSY_CCB0(value)              (TCC_SYNCBUSY_CCB0_Msk & (_UINT32_(value) << TCC_SYNCBUSY_CCB0_Pos)) /* Assignment of value for CCB0 in the TCC_SYNCBUSY register */
#define TCC_SYNCBUSY_CCB1_Pos                 _UINT32_(20)                                         /* (TCC_SYNCBUSY) Compare Channel Buffer 1 Busy Position */
#define TCC_SYNCBUSY_CCB1_Msk                 (_UINT32_(0x1) << TCC_SYNCBUSY_CCB1_Pos)             /* (TCC_SYNCBUSY) Compare Channel Buffer 1 Busy Mask */
#define TCC_SYNCBUSY_CCB1(value)              (TCC_SYNCBUSY_CCB1_Msk & (_UINT32_(value) << TCC_SYNCBUSY_CCB1_Pos)) /* Assignment of value for CCB1 in the TCC_SYNCBUSY register */
#define TCC_SYNCBUSY_CCB2_Pos                 _UINT32_(21)                                         /* (TCC_SYNCBUSY) Compare Channel Buffer 2 Busy Position */
#define TCC_SYNCBUSY_CCB2_Msk                 (_UINT32_(0x1) << TCC_SYNCBUSY_CCB2_Pos)             /* (TCC_SYNCBUSY) Compare Channel Buffer 2 Busy Mask */
#define TCC_SYNCBUSY_CCB2(value)              (TCC_SYNCBUSY_CCB2_Msk & (_UINT32_(value) << TCC_SYNCBUSY_CCB2_Pos)) /* Assignment of value for CCB2 in the TCC_SYNCBUSY register */
#define TCC_SYNCBUSY_CCB3_Pos                 _UINT32_(22)                                         /* (TCC_SYNCBUSY) Compare Channel Buffer 3 Busy Position */
#define TCC_SYNCBUSY_CCB3_Msk                 (_UINT32_(0x1) << TCC_SYNCBUSY_CCB3_Pos)             /* (TCC_SYNCBUSY) Compare Channel Buffer 3 Busy Mask */
#define TCC_SYNCBUSY_CCB3(value)              (TCC_SYNCBUSY_CCB3_Msk & (_UINT32_(value) << TCC_SYNCBUSY_CCB3_Pos)) /* Assignment of value for CCB3 in the TCC_SYNCBUSY register */
#define TCC_SYNCBUSY_Msk                      _UINT32_(0x007F0FFF)                                 /* (TCC_SYNCBUSY) Register Mask  */

#define TCC_SYNCBUSY_CC_Pos                   _UINT32_(8)                                          /* (TCC_SYNCBUSY Position) Compare Channel x Busy */
...
#define TCC_SYNCBUSY_CCB_Pos                  _UINT32_(19)                                         /* (TCC_SYNCBUSY Position) Compare Channel Buffer 3 Busy */
#define TCC_SYNCBUSY_CCB_Msk                  (_UINT32_(0xF) << TCC_SYNCBUSY_CCB_Pos)              /* (TCC_SYNCBUSY Mask) CCB */
#define TCC_SYNCBUSY_CCB(value)               (TCC_SYNCBUSY_CCB_Msk & (_UINT32_(value) << TCC_SYNCBUSY_CCB_Pos)) 
...
#define TCC_FCTRLA_SRC(value)                 (TCC_FCTRLA_SRC_Msk & (_UINT32_(value) << TCC_FCTRLA_SRC_Pos)) /* Assignment of value for SRC in the TCC_FCTRLA register */
...
#define TCC_FCTRLA_KEEP(value)                (TCC_FCTRLA_KEEP_Msk & (_UINT32_(value) << TCC_FCTRLA_KEEP_Pos)) /* Assignment of value for KEEP in the TCC_FCTRLA register */
...
#define TCC_FCTRLA_QUAL(value)                (TCC_FCTRLA_QUAL_Msk & (_UINT32_(value) << TCC_FCTRLA_QUAL_Pos)) /* Assignment of value for QUAL in the TCC_FCTRLA register */
...
#define TCC_FCTRLA_BLANK(value)               (TCC_FCTRLA_BLANK_Msk & (_UINT32_(value) << TCC_FCTRLA_BLANK_Pos)) /* Assignment of value for BLANK in the TCC_FCTRLA register */
#define   TCC_FCTRLA_BLANK_START_Val          _UINT32_(0x0)                                        /* (TCC_FCTRLA) Blanking applied from start of ramp  */
...
#define TCC_FCTRLA_BLANK_START                (TCC_FCTRLA_BLANK_START_Val << TCC_FCTRLA_BLANK_Pos) /* (TCC_FCTRLA) Blanking applied from start of ramp Position */
...
#define TCC_FCTRLA_RESTART(value)             (TCC_FCTRLA_RESTART_Msk & (_UINT32_(value) << TCC_FCTRLA_RESTART_Pos)) /* Assignment of value for RESTART in the TCC_FCTRLA register */
...
#define TCC_FCTRLA_HALT(value)                (TCC_FCTRLA_HALT_Msk & (_UINT32_(value) << TCC_FCTRLA_HALT_Pos)) /* Assignment of value for HALT in the TCC_FCTRLA register */
...
#define TCC_FCTRLA_CHSEL(value)               (TCC_FCTRLA_CHSEL_Msk & (_UINT32_(value) << TCC_FCTRLA_CHSEL_Pos)) /* Assignment of value for CHSEL in the TCC_FCTRLA register */
...
#define TCC_FCTRLA_CAPTURE(value)             (TCC_FCTRLA_CAPTURE_Msk & (_UINT32_(value) << TCC_FCTRLA_CAPTURE_Pos)) /* Assignment of value for CAPTURE in the TCC_FCTRLA register */
...
#define TCC_FCTRLA_BLANKVAL(value)            (TCC_FCTRLA_BLANKVAL_Msk & (_UINT32_(value) << TCC_FCTRLA_BLANKVAL_Pos)) /* Assignment of value for BLANKVAL in the TCC_FCTRLA register */
...
#define TCC_FCTRLA_FILTERVAL(value)           (TCC_FCTRLA_FILTERVAL_Msk & (_UINT32_(value) << TCC_FCTRLA_FILTERVAL_Pos)) /* Assignment of value for FILTERVAL in the TCC_FCTRLA register */
#define TCC_FCTRLA_Msk                        _UINT32_(0x0FFF7FFB)                                 /* (TCC_FCTRLA) Register Mask  */
...
#define TCC_FCTRLB_SRC(value)                 (TCC_FCTRLB_SRC_Msk & (_UINT32_(value) << TCC_FCTRLB_SRC_Pos)) /* Assignment of value for SRC in the TCC_FCTRLB register */
...
#define TCC_FCTRLB_KEEP(value)                (TCC_FCTRLB_KEEP_Msk & (_UINT32_(value) << TCC_FCTRLB_KEEP_Pos)) /* Assignment of value for KEEP in the TCC_FCTRLB register */
...
#define TCC_FCTRLB_QUAL(value)                (TCC_FCTRLB_QUAL_Msk & (_UINT32_(value) << TCC_FCTRLB_QUAL_Pos)) /* Assignment of value for QUAL in the TCC_FCTRLB register */
...
#define TCC_FCTRLB_BLANK(value)               (TCC_FCTRLB_BLANK_Msk & (_UINT32_(value) << TCC_FCTRLB_BLANK_Pos)) /* Assignment of value for BLANK in the TCC_FCTRLB register */
#define   TCC_FCTRLB_BLANK_START_Val          _UINT32_(0x0)                                        /* (TCC_FCTRLB) Blanking applied from start of ramp  */
...
#define TCC_FCTRLB_BLANK_START                (TCC_FCTRLB_BLANK_START_Val << TCC_FCTRLB_BLANK_Pos) /* (TCC_FCTRLB) Blanking applied from start of ramp Position */
...
#define TCC_FCTRLB_RESTART(value)             (TCC_FCTRLB_RESTART_Msk & (_UINT32_(value) << TCC_FCTRLB_RESTART_Pos)) /* Assignment of value for RESTART in the TCC_FCTRLB register */
...
#define TCC_FCTRLB_HALT(value)                (TCC_FCTRLB_HALT_Msk & (_UINT32_(value) << TCC_FCTRLB_HALT_Pos)) /* Assignment of value for HALT in the TCC_FCTRLB register */
...
#define TCC_FCTRLB_CHSEL(value)               (TCC_FCTRLB_CHSEL_Msk & (_UINT32_(value) << TCC_FCTRLB_CHSEL_Pos)) /* Assignment of value for CHSEL in the TCC_FCTRLB register */
...
#define TCC_FCTRLB_CAPTURE(value)             (TCC_FCTRLB_CAPTURE_Msk & (_UINT32_(value) << TCC_FCTRLB_CAPTURE_Pos)) /* Assignment of value for CAPTURE in the TCC_FCTRLB register */
...
#define TCC_FCTRLB_BLANKVAL(value)            (TCC_FCTRLB_BLANKVAL_Msk & (_UINT32_(value) << TCC_FCTRLB_BLANKVAL_Pos)) /* Assignment of value for BLANKVAL in the TCC_FCTRLB register */
...
#define TCC_FCTRLB_FILTERVAL(value)           (TCC_FCTRLB_FILTERVAL_Msk & (_UINT32_(value) << TCC_FCTRLB_FILTERVAL_Pos)) /* Assignment of value for FILTERVAL in the TCC_FCTRLB register */
#define TCC_FCTRLB_Msk                        _UINT32_(0x0FFF7FFB)                                 /* (TCC_FCTRLB) Register Mask  */
...
#define TCC_WEXCTRL_OTMX(value)               (TCC_WEXCTRL_OTMX_Msk & (_UINT32_(value) << TCC_WEXCTRL_OTMX_Pos)) /* Assignment of value for OTMX in the TCC_WEXCTRL register */
...
#define TCC_WEXCTRL_DTIEN0(value)             (TCC_WEXCTRL_DTIEN0_Msk & (_UINT32_(value) << TCC_WEXCTRL_DTIEN0_Pos)) /* Assignment of value for DTIEN0 in the TCC_WEXCTRL register */
...
#define TCC_WEXCTRL_DTIEN1(value)             (TCC_WEXCTRL_DTIEN1_Msk & (_UINT32_(value) << TCC_WEXCTRL_DTIEN1_Pos)) /* Assignment of value for DTIEN1 in the TCC_WEXCTRL register */
...
#define TCC_WEXCTRL_DTIEN2(value)             (TCC_WEXCTRL_DTIEN2_Msk & (_UINT32_(value) << TCC_WEXCTRL_DTIEN2_Pos)) /* Assignment of value for DTIEN2 in the TCC_WEXCTRL register */
...
#define TCC_WEXCTRL_DTIEN3(value)             (TCC_WEXCTRL_DTIEN3_Msk & (_UINT32_(value) << TCC_WEXCTRL_DTIEN3_Pos)) /* Assignment of value for DTIEN3 in the TCC_WEXCTRL register */
...
#define TCC_WEXCTRL_DTLS(value)               (TCC_WEXCTRL_DTLS_Msk & (_UINT32_(value) << TCC_WEXCTRL_DTLS_Pos)) /* Assignment of value for DTLS in the TCC_WEXCTRL register */
...
#define TCC_WEXCTRL_DTHS(value)               (TCC_WEXCTRL_DTHS_Msk & (_UINT32_(value) << TCC_WEXCTRL_DTHS_Pos)) /* Assignment of value for DTHS in the TCC_WEXCTRL register */
...
#define TCC_DRVCTRL_NRE0(value)               (TCC_DRVCTRL_NRE0_Msk & (_UINT32_(value) << TCC_DRVCTRL_NRE0_Pos)) /* Assignment of value for NRE0 in the TCC_DRVCTRL register */
...
#define TCC_DRVCTRL_NRE1(value)               (TCC_DRVCTRL_NRE1_Msk & (_UINT32_(value) << TCC_DRVCTRL_NRE1_Pos)) /* Assignment of value for NRE1 in the TCC_DRVCTRL register */
...
#define TCC_DRVCTRL_NRE2(value)               (TCC_DRVCTRL_NRE2_Msk & (_UINT32_(value) << TCC_DRVCTRL_NRE2_Pos)) /* Assignment of value for NRE2 in the TCC_DRVCTRL register */
...
#define TCC_DRVCTRL_NRE3(value)               (TCC_DRVCTRL_NRE3_Msk & (_UINT32_(value) << TCC_DRVCTRL_NRE3_Pos)) /* Assignment of value for NRE3 in the TCC_DRVCTRL register */
...
#define TCC_DRVCTRL_NRE4(value)               (TCC_DRVCTRL_NRE4_Msk & (_UINT32_(value) << TCC_DRVCTRL_NRE4_Pos)) /* Assignment of value for NRE4 in the TCC_DRVCTRL register */
...
#define TCC_DRVCTRL_NRE5(value)               (TCC_DRVCTRL_NRE5_Msk & (_UINT32_(value) << TCC_DRVCTRL_NRE5_Pos)) /* Assignment of value for NRE5 in the TCC_DRVCTRL register */
...
#define TCC_DRVCTRL_NRE6(value)               (TCC_DRVCTRL_NRE6_Msk & (_UINT32_(value) << TCC_DRVCTRL_NRE6_Pos)) /* Assignment of value for NRE6 in the TCC_DRVCTRL register */
...
#define TCC_DRVCTRL_NRE7(value)               (TCC_DRVCTRL_NRE7_Msk & (_UINT32_(value) << TCC_DRVCTRL_NRE7_Pos)) /* Assignment of value for NRE7 in the TCC_DRVCTRL register */
...
#define TCC_DRVCTRL_NRV0(value)               (TCC_DRVCTRL_NRV0_Msk & (_UINT32_(value) << TCC_DRVCTRL_NRV0_Pos)) /* Assignment of value for NRV0 in the TCC_DRVCTRL register */
...
#define TCC_DRVCTRL_NRV1(value)               (TCC_DRVCTRL_NRV1_Msk & (_UINT32_(value) << TCC_DRVCTRL_NRV1_Pos)) /* Assignment of value for NRV1 in the TCC_DRVCTRL register */
...
#define TCC_DRVCTRL_NRV2(value)               (TCC_DRVCTRL_NRV2_Msk & (_UINT32_(value) << TCC_DRVCTRL_NRV2_Pos)) /* Assignment of value for NRV2 in the TCC_DRVCTRL register */
...
#define TCC_DRVCTRL_NRV3(value)               (TCC_DRVCTRL_NRV3_Msk & (_UINT32_(value) << TCC_DRVCTRL_NRV3_Pos)) /* Assignment of value for NRV3 in the TCC_DRVCTRL register */
...
#define TCC_DRVCTRL_NRV4(value)               (TCC_DRVCTRL_NRV4_Msk & (_UINT32_(value) << TCC_DRVCTRL_NRV4_Pos)) /* Assignment of value for NRV4 in the TCC_DRVCTRL register */
...
#define TCC_DRVCTRL_NRV5(value)               (TCC_DRVCTRL_NRV5_Msk & (_UINT32_(value) << TCC_DRVCTRL_NRV5_Pos)) /* Assignment of value for NRV5 in the TCC_DRVCTRL register */
...
#define TCC_DRVCTRL_NRV6(value)               (TCC_DRVCTRL_NRV6_Msk & (_UINT32_(value) << TCC_DRVCTRL_NRV6_Pos)) /* Assignment of value for NRV6 in the TCC_DRVCTRL register */
...
#define TCC_DRVCTRL_NRV7(value)               (TCC_DRVCTRL_NRV7_Msk & (_UINT32_(value) << TCC_DRVCTRL_NRV7_Pos)) /* Assignment of value for NRV7 in the TCC_DRVCTRL register */
...
#define TCC_DRVCTRL_INVEN0(value)             (TCC_DRVCTRL_INVEN0_Msk & (_UINT32_(value) << TCC_DRVCTRL_INVEN0_Pos)) /* Assignment of value for INVEN0 in the TCC_DRVCTRL register */
...
#define TCC_DRVCTRL_INVEN1(value)             (TCC_DRVCTRL_INVEN1_Msk & (_UINT32_(value) << TCC_DRVCTRL_INVEN1_Pos)) /* Assignment of value for INVEN1 in the TCC_DRVCTRL register */
...
#define TCC_DRVCTRL_INVEN2(value)             (TCC_DRVCTRL_INVEN2_Msk & (_UINT32_(value) << TCC_DRVCTRL_INVEN2_Pos)) /* Assignment of value for INVEN2 in the TCC_DRVCTRL register */
...
#define TCC_DRVCTRL_INVEN3(value)             (TCC_DRVCTRL_INVEN3_Msk & (_UINT32_(value) << TCC_DRVCTRL_INVEN3_Pos)) /* Assignment of value for INVEN3 in the TCC_DRVCTRL register */
...
#define TCC_DRVCTRL_INVEN4(value)             (TCC_DRVCTRL_INVEN4_Msk & (_UINT32_(value) << TCC_DRVCTRL_INVEN4_Pos)) /* Assignment of value for INVEN4 in the TCC_DRVCTRL register */
...
#define TCC_DRVCTRL_INVEN5(value)             (TCC_DRVCTRL_INVEN5_Msk & (_UINT32_(value) << TCC_DRVCTRL_INVEN5_Pos)) /* Assignment of value for INVEN5 in the TCC_DRVCTRL register */
...
#define TCC_DRVCTRL_INVEN6(value)             (TCC_DRVCTRL_INVEN6_Msk & (_UINT32_(value) << TCC_DRVCTRL_INVEN6_Pos)) /* Assignment of value for INVEN6 in the TCC_DRVCTRL register */
...
#define TCC_DRVCTRL_INVEN7(value)             (TCC_DRVCTRL_INVEN7_Msk & (_UINT32_(value) << TCC_DRVCTRL_INVEN7_Pos)) /* Assignment of value for INVEN7 in the TCC_DRVCTRL register */
...
#define TCC_DRVCTRL_FILTERVAL0(value)         (TCC_DRVCTRL_FILTERVAL0_Msk & (_UINT32_(value) << TCC_DRVCTRL_FILTERVAL0_Pos)) /* Assignment of value for FILTERVAL0 in the TCC_DRVCTRL register */
...
#define TCC_DRVCTRL_FILTERVAL1(value)         (TCC_DRVCTRL_FILTERVAL1_Msk & (_UINT32_(value) << TCC_DRVCTRL_FILTERVAL1_Pos)) /* Assignment of value for FILTERVAL1 in the TCC_DRVCTRL register */
...
#define TCC_DBGCTRL_DBGRUN(value)             (TCC_DBGCTRL_DBGRUN_Msk & (_UINT8_(value) << TCC_DBGCTRL_DBGRUN_Pos)) /* Assignment of value for DBGRUN in the TCC_DBGCTRL register */
...
#define TCC_DBGCTRL_FDDBD(value)              (TCC_DBGCTRL_FDDBD_Msk & (_UINT8_(value) << TCC_DBGCTRL_FDDBD_Pos)) /* Assignment of value for FDDBD in the TCC_DBGCTRL register */
...
#define TCC_EVCTRL_EVACT0(value)              (TCC_EVCTRL_EVACT0_Msk & (_UINT32_(value) << TCC_EVCTRL_EVACT0_Pos)) /* Assignment of value for EVACT0 in the TCC_EVCTRL register */
...
#define TCC_EVCTRL_EVACT1(value)              (TCC_EVCTRL_EVACT1_Msk & (_UINT32_(value) << TCC_EVCTRL_EVACT1_Pos)) /* Assignment of value for EVACT1 in the TCC_EVCTRL register */
...
#define TCC_EVCTRL_CNTSEL(value)              (TCC_EVCTRL_CNTSEL_Msk & (_UINT32_(value) << TCC_EVCTRL_CNTSEL_Pos)) /* Assignment of value for CNTSEL in the TCC_EVCTRL register */
...
#define TCC_EVCTRL_OVFEO(value)               (TCC_EVCTRL_OVFEO_Msk & (_UINT32_(value) << TCC_EVCTRL_OVFEO_Pos)) /* Assignment of value for OVFEO in the TCC_EVCTRL register */
...
#define TCC_EVCTRL_TRGEO(value)               (TCC_EVCTRL_TRGEO_Msk & (_UINT32_(value) << TCC_EVCTRL_TRGEO_Pos)) /* Assignment of value for TRGEO in the TCC_EVCTRL register */
...
#define TCC_EVCTRL_CNTEO(value)               (TCC_EVCTRL_CNTEO_Msk & (_UINT32_(value) << TCC_EVCTRL_CNTEO_Pos)) /* Assignment of value for CNTEO in the TCC_EVCTRL register */
...
#define TCC_EVCTRL_TCINV0(value)              (TCC_EVCTRL_TCINV0_Msk & (_UINT32_(value) << TCC_EVCTRL_TCINV0_Pos)) /* Assignment of value for TCINV0 in the TCC_EVCTRL register */
...
#define TCC_EVCTRL_TCINV1(value)              (TCC_EVCTRL_TCINV1_Msk & (_UINT32_(value) << TCC_EVCTRL_TCINV1_Pos)) /* Assignment of value for TCINV1 in the TCC_EVCTRL register */
...
#define TCC_EVCTRL_TCEI0(value)               (TCC_EVCTRL_TCEI0_Msk & (_UINT32_(value) << TCC_EVCTRL_TCEI0_Pos)) /* Assignment of value for TCEI0 in the TCC_EVCTRL register */
...
#define TCC_EVCTRL_TCEI1(value)               (TCC_EVCTRL_TCEI1_Msk & (_UINT32_(value) << TCC_EVCTRL_TCEI1_Pos)) /* Assignment of value for TCEI1 in the TCC_EVCTRL register */
...
#define TCC_EVCTRL_MCEI0(value)               (TCC_EVCTRL_MCEI0_Msk & (_UINT32_(value) << TCC_EVCTRL_MCEI0_Pos)) /* Assignment of value for MCEI0 in the TCC_EVCTRL register */
...
#define TCC_EVCTRL_MCEI1(value)               (TCC_EVCTRL_MCEI1_Msk & (_UINT32_(value) << TCC_EVCTRL_MCEI1_Pos)) /* Assignment of value for MCEI1 in the TCC_EVCTRL register */
...
#define TCC_EVCTRL_MCEI2(value)               (TCC_EVCTRL_MCEI2_Msk & (_UINT32_(value) << TCC_EVCTRL_MCEI2_Pos)) /* Assignment of value for MCEI2 in the TCC_EVCTRL register */
...
#define TCC_EVCTRL_MCEI3(value)               (TCC_EVCTRL_MCEI3_Msk & (_UINT32_(value) << TCC_EVCTRL_MCEI3_Pos)) /* Assignment of value for MCEI3 in the TCC_EVCTRL register */
...
#define TCC_EVCTRL_MCEO0(value)               (TCC_EVCTRL_MCEO0_Msk & (_UINT32_(value) << TCC_EVCTRL_MCEO0_Pos)) /* Assignment of value for MCEO0 in the TCC_EVCTRL register */
...
#define TCC_EVCTRL_MCEO1(value)               (TCC_EVCTRL_MCEO1_Msk & (_UINT32_(value) << TCC_EVCTRL_MCEO1_Pos)) /* Assignment of value for MCEO1 in the TCC_EVCTRL register */
...
#define TCC_EVCTRL_MCEO2(value)               (TCC_EVCTRL_MCEO2_Msk & (_UINT32_(value) << TCC_EVCTRL_MCEO2_Pos)) /* Assignment of value for MCEO2 in the TCC_EVCTRL register */
...
#define TCC_EVCTRL_MCEO3(value)               (TCC_EVCTRL_MCEO3_Msk & (_UINT32_(value) << TCC_EVCTRL_MCEO3_Pos)) /* Assignment of value for MCEO3 in the TCC_EVCTRL register */
...
#define TCC_INTENCLR_OVF(value)               (TCC_INTENCLR_OVF_Msk & (_UINT32_(value) << TCC_INTENCLR_OVF_Pos)) /* Assignment of value for OVF in the TCC_INTENCLR register */
...
#define TCC_INTENCLR_TRG(value)               (TCC_INTENCLR_TRG_Msk & (_UINT32_(value) << TCC_INTENCLR_TRG_Pos)) /* Assignment of value for TRG in the TCC_INTENCLR register */
...
#define TCC_INTENCLR_CNT(value)               (TCC_INTENCLR_CNT_Msk & (_UINT32_(value) << TCC_INTENCLR_CNT_Pos)) /* Assignment of value for CNT in the TCC_INTENCLR register */
...
#define TCC_INTENCLR_ERR(value)               (TCC_INTENCLR_ERR_Msk & (_UINT32_(value) << TCC_INTENCLR_ERR_Pos)) /* Assignment of value for ERR in the TCC_INTENCLR register */
...
#define TCC_INTENCLR_UFS(value)               (TCC_INTENCLR_UFS_Msk & (_UINT32_(value) << TCC_INTENCLR_UFS_Pos)) /* Assignment of value for UFS in the TCC_INTENCLR register */
...
#define TCC_INTENCLR_DFS(value)               (TCC_INTENCLR_DFS_Msk & (_UINT32_(value) << TCC_INTENCLR_DFS_Pos)) /* Assignment of value for DFS in the TCC_INTENCLR register */
...
#define TCC_INTENCLR_FAULTA(value)            (TCC_INTENCLR_FAULTA_Msk & (_UINT32_(value) << TCC_INTENCLR_FAULTA_Pos)) /* Assignment of value for FAULTA in the TCC_INTENCLR register */
...
#define TCC_INTENCLR_FAULTB(value)            (TCC_INTENCLR_FAULTB_Msk & (_UINT32_(value) << TCC_INTENCLR_FAULTB_Pos)) /* Assignment of value for FAULTB in the TCC_INTENCLR register */
...
#define TCC_INTENCLR_FAULT0(value)            (TCC_INTENCLR_FAULT0_Msk & (_UINT32_(value) << TCC_INTENCLR_FAULT0_Pos)) /* Assignment of value for FAULT0 in the TCC_INTENCLR register */
...
#define TCC_INTENCLR_FAULT1(value)            (TCC_INTENCLR_FAULT1_Msk & (_UINT32_(value) << TCC_INTENCLR_FAULT1_Pos)) /* Assignment of value for FAULT1 in the TCC_INTENCLR register */
...
#define TCC_INTENCLR_MC0(value)               (TCC_INTENCLR_MC0_Msk & (_UINT32_(value) << TCC_INTENCLR_MC0_Pos)) /* Assignment of value for MC0 in the TCC_INTENCLR register */
...
#define TCC_INTENCLR_MC1(value)               (TCC_INTENCLR_MC1_Msk & (_UINT32_(value) << TCC_INTENCLR_MC1_Pos)) /* Assignment of value for MC1 in the TCC_INTENCLR register */
...
#define TCC_INTENCLR_MC2(value)               (TCC_INTENCLR_MC2_Msk & (_UINT32_(value) << TCC_INTENCLR_MC2_Pos)) /* Assignment of value for MC2 in the TCC_INTENCLR register */
...
#define TCC_INTENCLR_MC3(value)               (TCC_INTENCLR_MC3_Msk & (_UINT32_(value) << TCC_INTENCLR_MC3_Pos)) /* Assignment of value for MC3 in the TCC_INTENCLR register */
...
#define TCC_INTENSET_OVF(value)               (TCC_INTENSET_OVF_Msk & (_UINT32_(value) << TCC_INTENSET_OVF_Pos)) /* Assignment of value for OVF in the TCC_INTENSET register */
...
#define TCC_INTENSET_TRG(value)               (TCC_INTENSET_TRG_Msk & (_UINT32_(value) << TCC_INTENSET_TRG_Pos)) /* Assignment of value for TRG in the TCC_INTENSET register */
...
#define TCC_INTENSET_CNT(value)               (TCC_INTENSET_CNT_Msk & (_UINT32_(value) << TCC_INTENSET_CNT_Pos)) /* Assignment of value for CNT in the TCC_INTENSET register */
...
#define TCC_INTENSET_ERR(value)               (TCC_INTENSET_ERR_Msk & (_UINT32_(value) << TCC_INTENSET_ERR_Pos)) /* Assignment of value for ERR in the TCC_INTENSET register */
...
#define TCC_INTENSET_UFS(value)               (TCC_INTENSET_UFS_Msk & (_UINT32_(value) << TCC_INTENSET_UFS_Pos)) /* Assignment of value for UFS in the TCC_INTENSET register */
...
#define TCC_INTENSET_DFS(value)               (TCC_INTENSET_DFS_Msk & (_UINT32_(value) << TCC_INTENSET_DFS_Pos)) /* Assignment of value for DFS in the TCC_INTENSET register */
...
#define TCC_INTENSET_FAULTA(value)            (TCC_INTENSET_FAULTA_Msk & (_UINT32_(value) << TCC_INTENSET_FAULTA_Pos)) /* Assignment of value for FAULTA in the TCC_INTENSET register */
...
#define TCC_INTENSET_FAULTB(value)            (TCC_INTENSET_FAULTB_Msk & (_UINT32_(value) << TCC_INTENSET_FAULTB_Pos)) /* Assignment of value for FAULTB in the TCC_INTENSET register */
...
#define TCC_INTENSET_FAULT0(value)            (TCC_INTENSET_FAULT0_Msk & (_UINT32_(value) << TCC_INTENSET_FAULT0_Pos)) /* Assignment of value for FAULT0 in the TCC_INTENSET register */
...
#define TCC_INTENSET_FAULT1(value)            (TCC_INTENSET_FAULT1_Msk & (_UINT32_(value) << TCC_INTENSET_FAULT1_Pos)) /* Assignment of value for FAULT1 in the TCC_INTENSET register */
...
#define TCC_INTENSET_MC0(value)               (TCC_INTENSET_MC0_Msk & (_UINT32_(value) << TCC_INTENSET_MC0_Pos)) /* Assignment of value for MC0 in the TCC_INTENSET register */
...
#define TCC_INTENSET_MC1(value)               (TCC_INTENSET_MC1_Msk & (_UINT32_(value) << TCC_INTENSET_MC1_Pos)) /* Assignment of value for MC1 in the TCC_INTENSET register */
...
#define TCC_INTENSET_MC2(value)               (TCC_INTENSET_MC2_Msk & (_UINT32_(value) << TCC_INTENSET_MC2_Pos)) /* Assignment of value for MC2 in the TCC_INTENSET register */
...
#define TCC_INTENSET_MC3(value)               (TCC_INTENSET_MC3_Msk & (_UINT32_(value) << TCC_INTENSET_MC3_Pos)) /* Assignment of value for MC3 in the TCC_INTENSET register */
...
#define TCC_INTFLAG_OVF(value)                (TCC_INTFLAG_OVF_Msk & (_UINT32_(value) << TCC_INTFLAG_OVF_Pos)) /* Assignment of value for OVF in the TCC_INTFLAG register */
...
#define TCC_INTFLAG_TRG(value)                (TCC_INTFLAG_TRG_Msk & (_UINT32_(value) << TCC_INTFLAG_TRG_Pos)) /* Assignment of value for TRG in the TCC_INTFLAG register */
...
#define TCC_INTFLAG_CNT(value)                (TCC_INTFLAG_CNT_Msk & (_UINT32_(value) << TCC_INTFLAG_CNT_Pos)) /* Assignment of value for CNT in the TCC_INTFLAG register */
...
#define TCC_INTFLAG_ERR(value)                (TCC_INTFLAG_ERR_Msk & (_UINT32_(value) << TCC_INTFLAG_ERR_Pos)) /* Assignment of value for ERR in the TCC_INTFLAG register */
...
#define TCC_INTFLAG_UFS(value)                (TCC_INTFLAG_UFS_Msk & (_UINT32_(value) << TCC_INTFLAG_UFS_Pos)) /* Assignment of value for UFS in the TCC_INTFLAG register */
...
#define TCC_INTFLAG_DFS(value)                (TCC_INTFLAG_DFS_Msk & (_UINT32_(value) << TCC_INTFLAG_DFS_Pos)) /* Assignment of value for DFS in the TCC_INTFLAG register */
...
#define TCC_INTFLAG_FAULTA(value)             (TCC_INTFLAG_FAULTA_Msk & (_UINT32_(value) << TCC_INTFLAG_FAULTA_Pos)) /* Assignment of value for FAULTA in the TCC_INTFLAG register */
...
#define TCC_INTFLAG_FAULTB(value)             (TCC_INTFLAG_FAULTB_Msk & (_UINT32_(value) << TCC_INTFLAG_FAULTB_Pos)) /* Assignment of value for FAULTB in the TCC_INTFLAG register */
...
#define TCC_INTFLAG_FAULT0(value)             (TCC_INTFLAG_FAULT0_Msk & (_UINT32_(value) << TCC_INTFLAG_FAULT0_Pos)) /* Assignment of value for FAULT0 in the TCC_INTFLAG register */
...
#define TCC_INTFLAG_FAULT1(value)             (TCC_INTFLAG_FAULT1_Msk & (_UINT32_(value) << TCC_INTFLAG_FAULT1_Pos)) /* Assignment of value for FAULT1 in the TCC_INTFLAG register */
...
#define TCC_INTFLAG_MC0(value)                (TCC_INTFLAG_MC0_Msk & (_UINT32_(value) << TCC_INTFLAG_MC0_Pos)) /* Assignment of value for MC0 in the TCC_INTFLAG register */
...
#define TCC_INTFLAG_MC1(value)                (TCC_INTFLAG_MC1_Msk & (_UINT32_(value) << TCC_INTFLAG_MC1_Pos)) /* Assignment of value for MC1 in the TCC_INTFLAG register */
...
#define TCC_INTFLAG_MC2(value)                (TCC_INTFLAG_MC2_Msk & (_UINT32_(value) << TCC_INTFLAG_MC2_Pos)) /* Assignment of value for MC2 in the TCC_INTFLAG register */
...
#define TCC_INTFLAG_MC3(value)                (TCC_INTFLAG_MC3_Msk & (_UINT32_(value) << TCC_INTFLAG_MC3_Pos)) /* Assignment of value for MC3 in the TCC_INTFLAG register */
...
#define TCC_STATUS_STOP(value)                (TCC_STATUS_STOP_Msk & (_UINT32_(value) << TCC_STATUS_STOP_Pos)) /* Assignment of value for STOP in the TCC_STATUS register */
...
#define TCC_STATUS_IDX(value)                 (TCC_STATUS_IDX_Msk & (_UINT32_(value) << TCC_STATUS_IDX_Pos)) /* Assignment of value for IDX in the TCC_STATUS register */
...
#define TCC_STATUS_UFS(value)                 (TCC_STATUS_UFS_Msk & (_UINT32_(value) << TCC_STATUS_UFS_Pos)) /* Assignment of value for UFS in the TCC_STATUS register */
...
#define TCC_STATUS_DFS(value)                 (TCC_STATUS_DFS_Msk & (_UINT32_(value) << TCC_STATUS_DFS_Pos)) /* Assignment of value for DFS in the TCC_STATUS register */
...
#define TCC_STATUS_SLAVE(value)               (TCC_STATUS_SLAVE_Msk & (_UINT32_(value) << TCC_STATUS_SLAVE_Pos)) /* Assignment of value for SLAVE in the TCC_STATUS register */
#define TCC_STATUS_PATTBV_Pos                 _UINT32_(5)                                          /* (TCC_STATUS) Pattern Buffer Valid Position */
#define TCC_STATUS_PATTBV_Msk                 (_UINT32_(0x1) << TCC_STATUS_PATTBV_Pos)             /* (TCC_STATUS) Pattern Buffer Valid Mask */
#define TCC_STATUS_PATTBV(value)              (TCC_STATUS_PATTBV_Msk & (_UINT32_(value) << TCC_STATUS_PATTBV_Pos)) /* Assignment of value for PATTBV in the TCC_STATUS register */
#define TCC_STATUS_WAVEBV_Pos                 _UINT32_(6)                                          /* (TCC_STATUS) Wave Buffer Valid Position */
#define TCC_STATUS_WAVEBV_Msk                 (_UINT32_(0x1) << TCC_STATUS_WAVEBV_Pos)             /* (TCC_STATUS) Wave Buffer Valid Mask */
#define TCC_STATUS_WAVEBV(value)              (TCC_STATUS_WAVEBV_Msk & (_UINT32_(value) << TCC_STATUS_WAVEBV_Pos)) /* Assignment of value for WAVEBV in the TCC_STATUS register */
#define TCC_STATUS_PERBV_Pos                  _UINT32_(7)                                          /* (TCC_STATUS) Period Buffer Valid Position */
#define TCC_STATUS_PERBV_Msk                  (_UINT32_(0x1) << TCC_STATUS_PERBV_Pos)              /* (TCC_STATUS) Period Buffer Valid Mask */
#define TCC_STATUS_PERBV(value)               (TCC_STATUS_PERBV_Msk & (_UINT32_(value) << TCC_STATUS_PERBV_Pos)) /* Assignment of value for PERBV in the TCC_STATUS register */
...
#define TCC_STATUS_FAULTAIN(value)            (TCC_STATUS_FAULTAIN_Msk & (_UINT32_(value) << TCC_STATUS_FAULTAIN_Pos)) /* Assignment of value for FAULTAIN in the TCC_STATUS register */
...
#define TCC_STATUS_FAULTBIN(value)            (TCC_STATUS_FAULTBIN_Msk & (_UINT32_(value) << TCC_STATUS_FAULTBIN_Pos)) /* Assignment of value for FAULTBIN in the TCC_STATUS register */
...
#define TCC_STATUS_FAULT0IN(value)            (TCC_STATUS_FAULT0IN_Msk & (_UINT32_(value) << TCC_STATUS_FAULT0IN_Pos)) /* Assignment of value for FAULT0IN in the TCC_STATUS register */
...
#define TCC_STATUS_FAULT1IN(value)            (TCC_STATUS_FAULT1IN_Msk & (_UINT32_(value) << TCC_STATUS_FAULT1IN_Pos)) /* Assignment of value for FAULT1IN in the TCC_STATUS register */
...
#define TCC_STATUS_FAULTA(value)              (TCC_STATUS_FAULTA_Msk & (_UINT32_(value) << TCC_STATUS_FAULTA_Pos)) /* Assignment of value for FAULTA in the TCC_STATUS register */
...
#define TCC_STATUS_FAULTB(value)              (TCC_STATUS_FAULTB_Msk & (_UINT32_(value) << TCC_STATUS_FAULTB_Pos)) /* Assignment of value for FAULTB in the TCC_STATUS register */
...
#define TCC_STATUS_FAULT0(value)              (TCC_STATUS_FAULT0_Msk & (_UINT32_(value) << TCC_STATUS_FAULT0_Pos)) /* Assignment of value for FAULT0 in the TCC_STATUS register */
...
#define TCC_STATUS_FAULT1(value)              (TCC_STATUS_FAULT1_Msk & (_UINT32_(value) << TCC_STATUS_FAULT1_Pos)) /* Assignment of value for FAULT1 in the TCC_STATUS register */
#define TCC_STATUS_CCBV0_Pos                  _UINT32_(16)                                         /* (TCC_STATUS) Compare Channel 0 Buffer Valid Position */
#define TCC_STATUS_CCBV0_Msk                  (_UINT32_(0x1) << TCC_STATUS_CCBV0_Pos)              /* (TCC_STATUS) Compare Channel 0 Buffer Valid Mask */
#define TCC_STATUS_CCBV0(value)               (TCC_STATUS_CCBV0_Msk & (_UINT32_(value) << TCC_STATUS_CCBV0_Pos)) /* Assignment of value for CCBV0 in the TCC_STATUS register */
#define TCC_STATUS_CCBV1_Pos                  _UINT32_(17)                                         /* (TCC_STATUS) Compare Channel 1 Buffer Valid Position */
#define TCC_STATUS_CCBV1_Msk                  (_UINT32_(0x1) << TCC_STATUS_CCBV1_Pos)              /* (TCC_STATUS) Compare Channel 1 Buffer Valid Mask */
#define TCC_STATUS_CCBV1(value)               (TCC_STATUS_CCBV1_Msk & (_UINT32_(value) << TCC_STATUS_CCBV1_Pos)) /* Assignment of value for CCBV1 in the TCC_STATUS register */
#define TCC_STATUS_CCBV2_Pos                  _UINT32_(18)                                         /* (TCC_STATUS) Compare Channel 2 Buffer Valid Position */
#define TCC_STATUS_CCBV2_Msk                  (_UINT32_(0x1) << TCC_STATUS_CCBV2_Pos)              /* (TCC_STATUS) Compare Channel 2 Buffer Valid Mask */
#define TCC_STATUS_CCBV2(value)               (TCC_STATUS_CCBV2_Msk & (_UINT32_(value) << TCC_STATUS_CCBV2_Pos)) /* Assignment of value for CCBV2 in the TCC_STATUS register */
#define TCC_STATUS_CCBV3_Pos                  _UINT32_(19)                                         /* (TCC_STATUS) Compare Channel 3 Buffer Valid Position */
#define TCC_STATUS_CCBV3_Msk                  (_UINT32_(0x1) << TCC_STATUS_CCBV3_Pos)              /* (TCC_STATUS) Compare Channel 3 Buffer Valid Mask */
#define TCC_STATUS_CCBV3(value)               (TCC_STATUS_CCBV3_Msk & (_UINT32_(value) << TCC_STATUS_CCBV3_Pos)) /* Assignment of value for CCBV3 in the TCC_STATUS register */
...
#define TCC_STATUS_CMP0(value)                (TCC_STATUS_CMP0_Msk & (_UINT32_(value) << TCC_STATUS_CMP0_Pos)) /* Assignment of value for CMP0 in the TCC_STATUS register */
...
#define TCC_STATUS_CMP1(value)                (TCC_STATUS_CMP1_Msk & (_UINT32_(value) << TCC_STATUS_CMP1_Pos)) /* Assignment of value for CMP1 in the TCC_STATUS register */
...
#define TCC_STATUS_CMP2(value)                (TCC_STATUS_CMP2_Msk & (_UINT32_(value) << TCC_STATUS_CMP2_Pos)) /* Assignment of value for CMP2 in the TCC_STATUS register */
...
#define TCC_STATUS_CMP3(value)                (TCC_STATUS_CMP3_Msk & (_UINT32_(value) << TCC_STATUS_CMP3_Pos)) /* Assignment of value for CMP3 in the TCC_STATUS register */
#define TCC_STATUS_Msk                        _UINT32_(0x0F0FFFFF)                                 /* (TCC_STATUS) Register Mask  */
...
#define TCC_STATUS_CCBV_Pos                   _UINT32_(16)                                         /* (TCC_STATUS Position) Compare Channel x Buffer Valid */
#define TCC_STATUS_CCBV_Msk                   (_UINT32_(0xF) << TCC_STATUS_CCBV_Pos)               /* (TCC_STATUS Mask) CCBV */
#define TCC_STATUS_CCBV(value)                (TCC_STATUS_CCBV_Msk & (_UINT32_(value) << TCC_STATUS_CCBV_Pos)) 
...
#define TCC_COUNT_COUNT(value)                (TCC_COUNT_COUNT_Msk & (_UINT32_(value) << TCC_COUNT_COUNT_Pos)) /* Assignment of value for COUNT in the TCC_COUNT register */
...
#define TCC_PATT_PGE0(value)                  (TCC_PATT_PGE0_Msk & (_UINT16_(value) << TCC_PATT_PGE0_Pos)) /* Assignment of value for PGE0 in the TCC_PATT register */
...
#define TCC_PATT_PGE1(value)                  (TCC_PATT_PGE1_Msk & (_UINT16_(value) << TCC_PATT_PGE1_Pos)) /* Assignment of value for PGE1 in the TCC_PATT register */
...
#define TCC_PATT_PGE2(value)                  (TCC_PATT_PGE2_Msk & (_UINT16_(value) << TCC_PATT_PGE2_Pos)) /* Assignment of value for PGE2 in the TCC_PATT register */
...
#define TCC_PATT_PGE3(value)                  (TCC_PATT_PGE3_Msk & (_UINT16_(value) << TCC_PATT_PGE3_Pos)) /* Assignment of value for PGE3 in the TCC_PATT register */
...
#define TCC_PATT_PGE4(value)                  (TCC_PATT_PGE4_Msk & (_UINT16_(value) << TCC_PATT_PGE4_Pos)) /* Assignment of value for PGE4 in the TCC_PATT register */
...
#define TCC_PATT_PGE5(value)                  (TCC_PATT_PGE5_Msk & (_UINT16_(value) << TCC_PATT_PGE5_Pos)) /* Assignment of value for PGE5 in the TCC_PATT register */
...
#define TCC_PATT_PGE6(value)                  (TCC_PATT_PGE6_Msk & (_UINT16_(value) << TCC_PATT_PGE6_Pos)) /* Assignment of value for PGE6 in the TCC_PATT register */
...
#define TCC_PATT_PGE7(value)                  (TCC_PATT_PGE7_Msk & (_UINT16_(value) << TCC_PATT_PGE7_Pos)) /* Assignment of value for PGE7 in the TCC_PATT register */
...
#define TCC_PATT_PGV0(value)                  (TCC_PATT_PGV0_Msk & (_UINT16_(value) << TCC_PATT_PGV0_Pos)) /* Assignment of value for PGV0 in the TCC_PATT register */
...
#define TCC_PATT_PGV1(value)                  (TCC_PATT_PGV1_Msk & (_UINT16_(value) << TCC_PATT_PGV1_Pos)) /* Assignment of value for PGV1 in the TCC_PATT register */
...
#define TCC_PATT_PGV2(value)                  (TCC_PATT_PGV2_Msk & (_UINT16_(value) << TCC_PATT_PGV2_Pos)) /* Assignment of value for PGV2 in the TCC_PATT register */
...
#define TCC_PATT_PGV3(value)                  (TCC_PATT_PGV3_Msk & (_UINT16_(value) << TCC_PATT_PGV3_Pos)) /* Assignment of value for PGV3 in the TCC_PATT register */
...
#define TCC_PATT_PGV4(value)                  (TCC_PATT_PGV4_Msk & (_UINT16_(value) << TCC_PATT_PGV4_Pos)) /* Assignment of value for PGV4 in the TCC_PATT register */
...
#define TCC_PATT_PGV5(value)                  (TCC_PATT_PGV5_Msk & (_UINT16_(value) << TCC_PATT_PGV5_Pos)) /* Assignment of value for PGV5 in the TCC_PATT register */
...
#define TCC_PATT_PGV6(value)                  (TCC_PATT_PGV6_Msk & (_UINT16_(value) << TCC_PATT_PGV6_Pos)) /* Assignment of value for PGV6 in the TCC_PATT register */
...
#define TCC_PATT_PGV7(value)                  (TCC_PATT_PGV7_Msk & (_UINT16_(value) << TCC_PATT_PGV7_Pos)) /* Assignment of value for PGV7 in the TCC_PATT register */
...
#define TCC_WAVE_WAVEGEN(value)               (TCC_WAVE_WAVEGEN_Msk & (_UINT32_(value) << TCC_WAVE_WAVEGEN_Pos)) /* Assignment of value for WAVEGEN in the TCC_WAVE register */
...
#define TCC_WAVE_RAMP(value)                  (TCC_WAVE_RAMP_Msk & (_UINT32_(value) << TCC_WAVE_RAMP_Pos)) /* Assignment of value for RAMP in the TCC_WAVE register */
...
#define TCC_WAVE_CIPEREN(value)               (TCC_WAVE_CIPEREN_Msk & (_UINT32_(value) << TCC_WAVE_CIPEREN_Pos)) /* Assignment of value for CIPEREN in the TCC_WAVE register */
...
#define TCC_WAVE_CICCEN0(value)               (TCC_WAVE_CICCEN0_Msk & (_UINT32_(value) << TCC_WAVE_CICCEN0_Pos)) /* Assignment of value for CICCEN0 in the TCC_WAVE register */
...
#define TCC_WAVE_CICCEN1(value)               (TCC_WAVE_CICCEN1_Msk & (_UINT32_(value) << TCC_WAVE_CICCEN1_Pos)) /* Assignment of value for CICCEN1 in the TCC_WAVE register */
...
#define TCC_WAVE_CICCEN2(value)               (TCC_WAVE_CICCEN2_Msk & (_UINT32_(value) << TCC_WAVE_CICCEN2_Pos)) /* Assignment of value for CICCEN2 in the TCC_WAVE register */
...
#define TCC_WAVE_CICCEN3(value)               (TCC_WAVE_CICCEN3_Msk & (_UINT32_(value) << TCC_WAVE_CICCEN3_Pos)) /* Assignment of value for CICCEN3 in the TCC_WAVE register */
...
#define TCC_WAVE_POL0(value)                  (TCC_WAVE_POL0_Msk & (_UINT32_(value) << TCC_WAVE_POL0_Pos)) /* Assignment of value for POL0 in the TCC_WAVE register */
...
#define TCC_WAVE_POL1(value)                  (TCC_WAVE_POL1_Msk & (_UINT32_(value) << TCC_WAVE_POL1_Pos)) /* Assignment of value for POL1 in the TCC_WAVE register */
...
#define TCC_WAVE_POL2(value)                  (TCC_WAVE_POL2_Msk & (_UINT32_(value) << TCC_WAVE_POL2_Pos)) /* Assignment of value for POL2 in the TCC_WAVE register */
...
#define TCC_WAVE_POL3(value)                  (TCC_WAVE_POL3_Msk & (_UINT32_(value) << TCC_WAVE_POL3_Pos)) /* Assignment of value for POL3 in the TCC_WAVE register */
...
#define TCC_WAVE_SWAP0(value)                 (TCC_WAVE_SWAP0_Msk & (_UINT32_(value) << TCC_WAVE_SWAP0_Pos)) /* Assignment of value for SWAP0 in the TCC_WAVE register */
...
#define TCC_WAVE_SWAP1(value)                 (TCC_WAVE_SWAP1_Msk & (_UINT32_(value) << TCC_WAVE_SWAP1_Pos)) /* Assignment of value for SWAP1 in the TCC_WAVE register */
...
#define TCC_WAVE_SWAP2(value)                 (TCC_WAVE_SWAP2_Msk & (_UINT32_(value) << TCC_WAVE_SWAP2_Pos)) /* Assignment of value for SWAP2 in the TCC_WAVE register */
...
#define TCC_WAVE_SWAP3(value)                 (TCC_WAVE_SWAP3_Msk & (_UINT32_(value) << TCC_WAVE_SWAP3_Pos)) /* Assignment of value for SWAP3 in the TCC_WAVE register */
...
#define TCC_PER_PER(value)                    (TCC_PER_PER_Msk & (_UINT32_(value) << TCC_PER_PER_Pos)) /* Assignment of value for PER in the TCC_PER register */
#define TCC_PER_Msk                           _UINT32_(0x00FFFFFF)                                 /* (TCC_PER) Register Mask  */

/* DITH4 mode */
#define TCC_PER_DITH4_DITHERCY_Pos            _UINT32_(0)                                          /* (TCC_PER) Dithering Cycle Number Position */
#define TCC_PER_DITH4_DITHERCY_Msk            (_UINT32_(0xF) << TCC_PER_DITH4_DITHERCY_Pos)        /* (TCC_PER) Dithering Cycle Number Mask */
#define TCC_PER_DITH4_DITHERCY(value)         (TCC_PER_DITH4_DITHERCY_Msk & (_UINT32_(value) << TCC_PER_DITH4_DITHERCY_Pos))
...
/* DITH5 mode */
#define TCC_PER_DITH5_DITHERCY_Pos            _UINT32_(0)                                          /* (TCC_PER) Dithering Cycle Number Position */
#define TCC_PER_DITH5_DITHERCY_Msk            (_UINT32_(0x1F) << TCC_PER_DITH5_DITHERCY_Pos)       /* (TCC_PER) Dithering Cycle Number Mask */
#define TCC_PER_DITH5_DITHERCY(value)         (TCC_PER_DITH5_DITHERCY_Msk & (_UINT32_(value) << TCC_PER_DITH5_DITHERCY_Pos))
...
/* DITH6 mode */
#define TCC_PER_DITH6_DITHERCY_Pos            _UINT32_(0)                                          /* (TCC_PER) Dithering Cycle Number Position */
#define TCC_PER_DITH6_DITHERCY_Msk            (_UINT32_(0x3F) << TCC_PER_DITH6_DITHERCY_Pos)       /* (TCC_PER) Dithering Cycle Number Mask */
#define TCC_PER_DITH6_DITHERCY(value)         (TCC_PER_DITH6_DITHERCY_Msk & (_UINT32_(value) << TCC_PER_DITH6_DITHERCY_Pos))
...
#define TCC_CC_CC(value)                      (TCC_CC_CC_Msk & (_UINT32_(value) << TCC_CC_CC_Pos)) /* Assignment of value for CC in the TCC_CC register */
#define TCC_CC_Msk                            _UINT32_(0x00FFFFFF)                                 /* (TCC_CC) Register Mask  */

/* DITH4 mode */
#define TCC_CC_DITH4_DITHERCY_Pos             _UINT32_(0)                                          /* (TCC_CC) Dithering Cycle Number Position */
#define TCC_CC_DITH4_DITHERCY_Msk             (_UINT32_(0xF) << TCC_CC_DITH4_DITHERCY_Pos)         /* (TCC_CC) Dithering Cycle Number Mask */
#define TCC_CC_DITH4_DITHERCY(value)          (TCC_CC_DITH4_DITHERCY_Msk & (_UINT32_(value) << TCC_CC_DITH4_DITHERCY_Pos))
...
/* DITH5 mode */
#define TCC_CC_DITH5_DITHERCY_Pos             _UINT32_(0)                                          /* (TCC_CC) Dithering Cycle Number Position */
#define TCC_CC_DITH5_DITHERCY_Msk             (_UINT32_(0x1F) << TCC_CC_DITH5_DITHERCY_Pos)        /* (TCC_CC) Dithering Cycle Number Mask */
#define TCC_CC_DITH5_DITHERCY(value)          (TCC_CC_DITH5_DITHERCY_Msk & (_UINT32_(value) << TCC_CC_DITH5_DITHERCY_Pos))
...
/* DITH6 mode */
#define TCC_CC_DITH6_DITHERCY_Pos             _UINT32_(0)                                          /* (TCC_CC) Dithering Cycle Number Position */
#define TCC_CC_DITH6_DITHERCY_Msk             (_UINT32_(0x3F) << TCC_CC_DITH6_DITHERCY_Pos)        /* (TCC_CC) Dithering Cycle Number Mask */
#define TCC_CC_DITH6_DITHERCY(value)          (TCC_CC_DITH6_DITHERCY_Msk & (_UINT32_(value) << TCC_CC_DITH6_DITHERCY_Pos))
...
#define TCC_PATTB_RESETVALUE                  _UINT16_(0x00)                                       /*  (TCC_PATTB) Pattern Buffer  Reset Value */

#define TCC_PATTB_PGEB0_Pos                   _UINT16_(0)                                          /* (TCC_PATTB) Pattern Generator 0 Output Enable Buffer Position */
#define TCC_PATTB_PGEB0_Msk                   (_UINT16_(0x1) << TCC_PATTB_PGEB0_Pos)               /* (TCC_PATTB) Pattern Generator 0 Output Enable Buffer Mask */
#define TCC_PATTB_PGEB0(value)                (TCC_PATTB_PGEB0_Msk & (_UINT16_(value) << TCC_PATTB_PGEB0_Pos)) /* Assignment of value for PGEB0 in the TCC_PATTB register */
#define TCC_PATTB_PGEB1_Pos                   _UINT16_(1)                                          /* (TCC_PATTB) Pattern Generator 1 Output Enable Buffer Position */
#define TCC_PATTB_PGEB1_Msk                   (_UINT16_(0x1) << TCC_PATTB_PGEB1_Pos)               /* (TCC_PATTB) Pattern Generator 1 Output Enable Buffer Mask */
#define TCC_PATTB_PGEB1(value)                (TCC_PATTB_PGEB1_Msk & (_UINT16_(value) << TCC_PATTB_PGEB1_Pos)) /* Assignment of value for PGEB1 in the TCC_PATTB register */
#define TCC_PATTB_PGEB2_Pos                   _UINT16_(2)                                          /* (TCC_PATTB) Pattern Generator 2 Output Enable Buffer Position */
#define TCC_PATTB_PGEB2_Msk                   (_UINT16_(0x1) << TCC_PATTB_PGEB2_Pos)               /* (TCC_PATTB) Pattern Generator 2 Output Enable Buffer Mask */
#define TCC_PATTB_PGEB2(value)                (TCC_PATTB_PGEB2_Msk & (_UINT16_(value) << TCC_PATTB_PGEB2_Pos)) /* Assignment of value for PGEB2 in the TCC_PATTB register */
#define TCC_PATTB_PGEB3_Pos                   _UINT16_(3)                                          /* (TCC_PATTB) Pattern Generator 3 Output Enable Buffer Position */
#define TCC_PATTB_PGEB3_Msk                   (_UINT16_(0x1) << TCC_PATTB_PGEB3_Pos)               /* (TCC_PATTB) Pattern Generator 3 Output Enable Buffer Mask */
#define TCC_PATTB_PGEB3(value)                (TCC_PATTB_PGEB3_Msk & (_UINT16_(value) << TCC_PATTB_PGEB3_Pos)) /* Assignment of value for PGEB3 in the TCC_PATTB register */
#define TCC_PATTB_PGEB4_Pos                   _UINT16_(4)                                          /* (TCC_PATTB) Pattern Generator 4 Output Enable Buffer Position */
#define TCC_PATTB_PGEB4_Msk                   (_UINT16_(0x1) << TCC_PATTB_PGEB4_Pos)               /* (TCC_PATTB) Pattern Generator 4 Output Enable Buffer Mask */
#define TCC_PATTB_PGEB4(value)                (TCC_PATTB_PGEB4_Msk & (_UINT16_(value) << TCC_PATTB_PGEB4_Pos)) /* Assignment of value for PGEB4 in the TCC_PATTB register */
#define TCC_PATTB_PGEB5_Pos                   _UINT16_(5)                                          /* (TCC_PATTB) Pattern Generator 5 Output Enable Buffer Position */
#define TCC_PATTB_PGEB5_Msk                   (_UINT16_(0x1) << TCC_PATTB_PGEB5_Pos)               /* (TCC_PATTB) Pattern Generator 5 Output Enable Buffer Mask */
#define TCC_PATTB_PGEB5(value)                (TCC_PATTB_PGEB5_Msk & (_UINT16_(value) << TCC_PATTB_PGEB5_Pos)) /* Assignment of value for PGEB5 in the TCC_PATTB register */
#define TCC_PATTB_PGEB6_Pos                   _UINT16_(6)                                          /* (TCC_PATTB) Pattern Generator 6 Output Enable Buffer Position */
#define TCC_PATTB_PGEB6_Msk                   (_UINT16_(0x1) << TCC_PATTB_PGEB6_Pos)               /* (TCC_PATTB) Pattern Generator 6 Output Enable Buffer Mask */
#define TCC_PATTB_PGEB6(value)                (TCC_PATTB_PGEB6_Msk & (_UINT16_(value) << TCC_PATTB_PGEB6_Pos)) /* Assignment of value for PGEB6 in the TCC_PATTB register */
#define TCC_PATTB_PGEB7_Pos                   _UINT16_(7)                                          /* (TCC_PATTB) Pattern Generator 7 Output Enable Buffer Position */
#define TCC_PATTB_PGEB7_Msk                   (_UINT16_(0x1) << TCC_PATTB_PGEB7_Pos)               /* (TCC_PATTB) Pattern Generator 7 Output Enable Buffer Mask */
#define TCC_PATTB_PGEB7(value)                (TCC_PATTB_PGEB7_Msk & (_UINT16_(value) << TCC_PATTB_PGEB7_Pos)) /* Assignment of value for PGEB7 in the TCC_PATTB register */
#define TCC_PATTB_PGVB0_Pos                   _UINT16_(8)                                          /* (TCC_PATTB) Pattern Generator 0 Output Enable Position */
#define TCC_PATTB_PGVB0_Msk                   (_UINT16_(0x1) << TCC_PATTB_PGVB0_Pos)               /* (TCC_PATTB) Pattern Generator 0 Output Enable Mask */
#define TCC_PATTB_PGVB0(value)                (TCC_PATTB_PGVB0_Msk & (_UINT16_(value) << TCC_PATTB_PGVB0_Pos)) /* Assignment of value for PGVB0 in the TCC_PATTB register */
#define TCC_PATTB_PGVB1_Pos                   _UINT16_(9)                                          /* (TCC_PATTB) Pattern Generator 1 Output Enable Position */
#define TCC_PATTB_PGVB1_Msk                   (_UINT16_(0x1) << TCC_PATTB_PGVB1_Pos)               /* (TCC_PATTB) Pattern Generator 1 Output Enable Mask */
#define TCC_PATTB_PGVB1(value)                (TCC_PATTB_PGVB1_Msk & (_UINT16_(value) << TCC_PATTB_PGVB1_Pos)) /* Assignment of value for PGVB1 in the TCC_PATTB register */
#define TCC_PATTB_PGVB2_Pos                   _UINT16_(10)                                         /* (TCC_PATTB) Pattern Generator 2 Output Enable Position */
#define TCC_PATTB_PGVB2_Msk                   (_UINT16_(0x1) << TCC_PATTB_PGVB2_Pos)               /* (TCC_PATTB) Pattern Generator 2 Output Enable Mask */
#define TCC_PATTB_PGVB2(value)                (TCC_PATTB_PGVB2_Msk & (_UINT16_(value) << TCC_PATTB_PGVB2_Pos)) /* Assignment of value for PGVB2 in the TCC_PATTB register */
#define TCC_PATTB_PGVB3_Pos                   _UINT16_(11)                                         /* (TCC_PATTB) Pattern Generator 3 Output Enable Position */
#define TCC_PATTB_PGVB3_Msk                   (_UINT16_(0x1) << TCC_PATTB_PGVB3_Pos)               /* (TCC_PATTB) Pattern Generator 3 Output Enable Mask */
#define TCC_PATTB_PGVB3(value)                (TCC_PATTB_PGVB3_Msk & (_UINT16_(value) << TCC_PATTB_PGVB3_Pos)) /* Assignment of value for PGVB3 in the TCC_PATTB register */
#define TCC_PATTB_PGVB4_Pos                   _UINT16_(12)                                         /* (TCC_PATTB) Pattern Generator 4 Output Enable Position */
#define TCC_PATTB_PGVB4_Msk                   (_UINT16_(0x1) << TCC_PATTB_PGVB4_Pos)               /* (TCC_PATTB) Pattern Generator 4 Output Enable Mask */
#define TCC_PATTB_PGVB4(value)                (TCC_PATTB_PGVB4_Msk & (_UINT16_(value) << TCC_PATTB_PGVB4_Pos)) /* Assignment of value for PGVB4 in the TCC_PATTB register */
#define TCC_PATTB_PGVB5_Pos                   _UINT16_(13)                                         /* (TCC_PATTB) Pattern Generator 5 Output Enable Position */
#define TCC_PATTB_PGVB5_Msk                   (_UINT16_(0x1) << TCC_PATTB_PGVB5_Pos)               /* (TCC_PATTB) Pattern Generator 5 Output Enable Mask */
#define TCC_PATTB_PGVB5(value)                (TCC_PATTB_PGVB5_Msk & (_UINT16_(value) << TCC_PATTB_PGVB5_Pos)) /* Assignment of value for PGVB5 in the TCC_PATTB register */
#define TCC_PATTB_PGVB6_Pos                   _UINT16_(14)                                         /* (TCC_PATTB) Pattern Generator 6 Output Enable Position */
#define TCC_PATTB_PGVB6_Msk                   (_UINT16_(0x1) << TCC_PATTB_PGVB6_Pos)               /* (TCC_PATTB) Pattern Generator 6 Output Enable Mask */
#define TCC_PATTB_PGVB6(value)                (TCC_PATTB_PGVB6_Msk & (_UINT16_(value) << TCC_PATTB_PGVB6_Pos)) /* Assignment of value for PGVB6 in the TCC_PATTB register */
#define TCC_PATTB_PGVB7_Pos                   _UINT16_(15)                                         /* (TCC_PATTB) Pattern Generator 7 Output Enable Position */
#define TCC_PATTB_PGVB7_Msk                   (_UINT16_(0x1) << TCC_PATTB_PGVB7_Pos)               /* (TCC_PATTB) Pattern Generator 7 Output Enable Mask */
#define TCC_PATTB_PGVB7(value)                (TCC_PATTB_PGVB7_Msk & (_UINT16_(value) << TCC_PATTB_PGVB7_Pos)) /* Assignment of value for PGVB7 in the TCC_PATTB register */
#define TCC_PATTB_Msk                         _UINT16_(0xFFFF)                                     /* (TCC_PATTB) Register Mask  */

#define TCC_PATTB_PGEB_Pos                    _UINT16_(0)                                          /* (TCC_PATTB Position) Pattern Generator x Output Enable Buffer */
#define TCC_PATTB_PGEB_Msk                    (_UINT16_(0xFF) << TCC_PATTB_PGEB_Pos)               /* (TCC_PATTB Mask) PGEB */
#define TCC_PATTB_PGEB(value)                 (TCC_PATTB_PGEB_Msk & (_UINT16_(value) << TCC_PATTB_PGEB_Pos)) 
#define TCC_PATTB_PGVB_Pos                    _UINT16_(8)                                          /* (TCC_PATTB Position) Pattern Generator 7 Output Enable */
#define TCC_PATTB_PGVB_Msk                    (_UINT16_(0xFF) << TCC_PATTB_PGVB_Pos)               /* (TCC_PATTB Mask) PGVB */
#define TCC_PATTB_PGVB(value)                 (TCC_PATTB_PGVB_Msk & (_UINT16_(value) << TCC_PATTB_PGVB_Pos)) 

/* -------- TCC_WAVEB : (TCC Offset: 0x68) (R/W 32) Waveform Control Buffer -------- */
#define TCC_WAVEB_RESETVALUE                  _UINT32_(0x00)                                       /*  (TCC_WAVEB) Waveform Control Buffer  Reset Value */

#define TCC_WAVEB_WAVEGENB_Pos                _UINT32_(0)                                          /* (TCC_WAVEB) Waveform Generation Buffer Position */
#define TCC_WAVEB_WAVEGENB_Msk                (_UINT32_(0x7) << TCC_WAVEB_WAVEGENB_Pos)            /* (TCC_WAVEB) Waveform Generation Buffer Mask */
#define TCC_WAVEB_WAVEGENB(value)             (TCC_WAVEB_WAVEGENB_Msk & (_UINT32_(value) << TCC_WAVEB_WAVEGENB_Pos)) /* Assignment of value for WAVEGENB in the TCC_WAVEB register */
#define   TCC_WAVEB_WAVEGENB_NFRQ_Val         _UINT32_(0x0)                                        /* (TCC_WAVEB) Normal frequency  */
#define   TCC_WAVEB_WAVEGENB_MFRQ_Val         _UINT32_(0x1)                                        /* (TCC_WAVEB) Match frequency  */
#define   TCC_WAVEB_WAVEGENB_NPWM_Val         _UINT32_(0x2)                                        /* (TCC_WAVEB) Normal PWM  */
#define   TCC_WAVEB_WAVEGENB_DSCRITICAL_Val   _UINT32_(0x4)                                        /* (TCC_WAVEB) Dual-slope critical  */
#define   TCC_WAVEB_WAVEGENB_DSBOTTOM_Val     _UINT32_(0x5)                                        /* (TCC_WAVEB) Dual-slope with interrupt/event condition when COUNT reaches ZERO  */
#define   TCC_WAVEB_WAVEGENB_DSBOTH_Val       _UINT32_(0x6)                                        /* (TCC_WAVEB) Dual-slope with interrupt/event condition when COUNT reaches ZERO or TOP  */
#define   TCC_WAVEB_WAVEGENB_DSTOP_Val        _UINT32_(0x7)                                        /* (TCC_WAVEB) Dual-slope with interrupt/event condition when COUNT reaches TOP  */
...
#define TCC_WAVEB_RAMPB_Pos                   _UINT32_(4)                                          /* (TCC_WAVEB) Ramp Mode Buffer Position */
#define TCC_WAVEB_RAMPB_Msk                   (_UINT32_(0x3) << TCC_WAVEB_RAMPB_Pos)               /* (TCC_WAVEB) Ramp Mode Buffer Mask */
#define TCC_WAVEB_RAMPB(value)                (TCC_WAVEB_RAMPB_Msk & (_UINT32_(value) << TCC_WAVEB_RAMPB_Pos)) /* Assignment of value for RAMPB in the TCC_WAVEB register */
#define   TCC_WAVEB_RAMPB_RAMP1_Val           _UINT32_(0x0)                                        /* (TCC_WAVEB) RAMP1 operation  */
#define   TCC_WAVEB_RAMPB_RAMP2A_Val          _UINT32_(0x1)                                        /* (TCC_WAVEB) Alternative RAMP2 operation  */
#define   TCC_WAVEB_RAMPB_RAMP2_Val           _UINT32_(0x2)                                        /* (TCC_WAVEB) RAMP2 operation  */
#define   TCC_WAVEB_RAMPB_RAMP2C_Val          _UINT32_(0x3)                                        /* (TCC_WAVEB) Critical RAMP2 operation  */
...
#define TCC_WAVEB_RAMPB_RAMP2C                (TCC_WAVEB_RAMPB_RAMP2C_Val << TCC_WAVEB_RAMPB_Pos)  /* (TCC_WAVEB) Critical RAMP2 operation Position */
#define TCC_WAVEB_CIPERENB_Pos                _UINT32_(7)                                          /* (TCC_WAVEB) Circular Period Enable Buffer Position */
#define TCC_WAVEB_CIPERENB_Msk                (_UINT32_(0x1) << TCC_WAVEB_CIPERENB_Pos)            /* (TCC_WAVEB) Circular Period Enable Buffer Mask */
#define TCC_WAVEB_CIPERENB(value)             (TCC_WAVEB_CIPERENB_Msk & (_UINT32_(value) << TCC_WAVEB_CIPERENB_Pos)) /* Assignment of value for CIPERENB in the TCC_WAVEB register */
#define TCC_WAVEB_CICCENB0_Pos                _UINT32_(8)                                          /* (TCC_WAVEB) Circular Channel 0 Enable Buffer Position */
#define TCC_WAVEB_CICCENB0_Msk                (_UINT32_(0x1) << TCC_WAVEB_CICCENB0_Pos)            /* (TCC_WAVEB) Circular Channel 0 Enable Buffer Mask */
#define TCC_WAVEB_CICCENB0(value)             (TCC_WAVEB_CICCENB0_Msk & (_UINT32_(value) << TCC_WAVEB_CICCENB0_Pos)) /* Assignment of value for CICCENB0 in the TCC_WAVEB register */
#define TCC_WAVEB_CICCENB1_Pos                _UINT32_(9)                                          /* (TCC_WAVEB) Circular Channel 1 Enable Buffer Position */
#define TCC_WAVEB_CICCENB1_Msk                (_UINT32_(0x1) << TCC_WAVEB_CICCENB1_Pos)            /* (TCC_WAVEB) Circular Channel 1 Enable Buffer Mask */
#define TCC_WAVEB_CICCENB1(value)             (TCC_WAVEB_CICCENB1_Msk & (_UINT32_(value) << TCC_WAVEB_CICCENB1_Pos)) /* Assignment of value for CICCENB1 in the TCC_WAVEB register */
#define TCC_WAVEB_CICCENB2_Pos                _UINT32_(10)                                         /* (TCC_WAVEB) Circular Channel 2 Enable Buffer Position */
#define TCC_WAVEB_CICCENB2_Msk                (_UINT32_(0x1) << TCC_WAVEB_CICCENB2_Pos)            /* (TCC_WAVEB) Circular Channel 2 Enable Buffer Mask */
#define TCC_WAVEB_CICCENB2(value)             (TCC_WAVEB_CICCENB2_Msk & (_UINT32_(value) << TCC_WAVEB_CICCENB2_Pos)) /* Assignment of value for CICCENB2 in the TCC_WAVEB register */
#define TCC_WAVEB_CICCENB3_Pos                _UINT32_(11)                                         /* (TCC_WAVEB) Circular Channel 3 Enable Buffer Position */
#define TCC_WAVEB_CICCENB3_Msk                (_UINT32_(0x1) << TCC_WAVEB_CICCENB3_Pos)            /* (TCC_WAVEB) Circular Channel 3 Enable Buffer Mask */
#define TCC_WAVEB_CICCENB3(value)             (TCC_WAVEB_CICCENB3_Msk & (_UINT32_(value) << TCC_WAVEB_CICCENB3_Pos)) /* Assignment of value for CICCENB3 in the TCC_WAVEB register */
#define TCC_WAVEB_POLB0_Pos                   _UINT32_(16)                                         /* (TCC_WAVEB) Channel 0 Polarity Buffer Position */
#define TCC_WAVEB_POLB0_Msk                   (_UINT32_(0x1) << TCC_WAVEB_POLB0_Pos)               /* (TCC_WAVEB) Channel 0 Polarity Buffer Mask */
#define TCC_WAVEB_POLB0(value)                (TCC_WAVEB_POLB0_Msk & (_UINT32_(value) << TCC_WAVEB_POLB0_Pos)) /* Assignment of value for POLB0 in the TCC_WAVEB register */
#define TCC_WAVEB_POLB1_Pos                   _UINT32_(17)                                         /* (TCC_WAVEB) Channel 1 Polarity Buffer Position */
#define TCC_WAVEB_POLB1_Msk                   (_UINT32_(0x1) << TCC_WAVEB_POLB1_Pos)               /* (TCC_WAVEB) Channel 1 Polarity Buffer Mask */
#define TCC_WAVEB_POLB1(value)                (TCC_WAVEB_POLB1_Msk & (_UINT32_(value) << TCC_WAVEB_POLB1_Pos)) /* Assignment of value for POLB1 in the TCC_WAVEB register */
#define TCC_WAVEB_POLB2_Pos                   _UINT32_(18)                                         /* (TCC_WAVEB) Channel 2 Polarity Buffer Position */
#define TCC_WAVEB_POLB2_Msk                   (_UINT32_(0x1) << TCC_WAVEB_POLB2_Pos)               /* (TCC_WAVEB) Channel 2 Polarity Buffer Mask */
#define TCC_WAVEB_POLB2(value)                (TCC_WAVEB_POLB2_Msk & (_UINT32_(value) << TCC_WAVEB_POLB2_Pos)) /* Assignment of value for POLB2 in the TCC_WAVEB register */
#define TCC_WAVEB_POLB3_Pos                   _UINT32_(19)                                         /* (TCC_WAVEB) Channel 3 Polarity Buffer Position */
#define TCC_WAVEB_POLB3_Msk                   (_UINT32_(0x1) << TCC_WAVEB_POLB3_Pos)               /* (TCC_WAVEB) Channel 3 Polarity Buffer Mask */
#define TCC_WAVEB_POLB3(value)                (TCC_WAVEB_POLB3_Msk & (_UINT32_(value) << TCC_WAVEB_POLB3_Pos)) /* Assignment of value for POLB3 in the TCC_WAVEB register */
#define TCC_WAVEB_SWAPB0_Pos                  _UINT32_(24)                                         /* (TCC_WAVEB) Swap DTI Output Pair 0 Buffer Position */
#define TCC_WAVEB_SWAPB0_Msk                  (_UINT32_(0x1) << TCC_WAVEB_SWAPB0_Pos)              /* (TCC_WAVEB) Swap DTI Output Pair 0 Buffer Mask */
#define TCC_WAVEB_SWAPB0(value)               (TCC_WAVEB_SWAPB0_Msk & (_UINT32_(value) << TCC_WAVEB_SWAPB0_Pos)) /* Assignment of value for SWAPB0 in the TCC_WAVEB register */
#define TCC_WAVEB_SWAPB1_Pos                  _UINT32_(25)                                         /* (TCC_WAVEB) Swap DTI Output Pair 1 Buffer Position */
#define TCC_WAVEB_SWAPB1_Msk                  (_UINT32_(0x1) << TCC_WAVEB_SWAPB1_Pos)              /* (TCC_WAVEB) Swap DTI Output Pair 1 Buffer Mask */
#define TCC_WAVEB_SWAPB1(value)               (TCC_WAVEB_SWAPB1_Msk & (_UINT32_(value) << TCC_WAVEB_SWAPB1_Pos)) /* Assignment of value for SWAPB1 in the TCC_WAVEB register */
#define TCC_WAVEB_SWAPB2_Pos                  _UINT32_(26)                                         /* (TCC_WAVEB) Swap DTI Output Pair 2 Buffer Position */
#define TCC_WAVEB_SWAPB2_Msk                  (_UINT32_(0x1) << TCC_WAVEB_SWAPB2_Pos)              /* (TCC_WAVEB) Swap DTI Output Pair 2 Buffer Mask */
#define TCC_WAVEB_SWAPB2(value)               (TCC_WAVEB_SWAPB2_Msk & (_UINT32_(value) << TCC_WAVEB_SWAPB2_Pos)) /* Assignment of value for SWAPB2 in the TCC_WAVEB register */
#define TCC_WAVEB_SWAPB3_Pos                  _UINT32_(27)                                         /* (TCC_WAVEB) Swap DTI Output Pair 3 Buffer Position */
#define TCC_WAVEB_SWAPB3_Msk                  (_UINT32_(0x1) << TCC_WAVEB_SWAPB3_Pos)              /* (TCC_WAVEB) Swap DTI Output Pair 3 Buffer Mask */
#define TCC_WAVEB_SWAPB3(value)               (TCC_WAVEB_SWAPB3_Msk & (_UINT32_(value) << TCC_WAVEB_SWAPB3_Pos)) /* Assignment of value for SWAPB3 in the TCC_WAVEB register */
#define TCC_WAVEB_Msk                         _UINT32_(0x0F0F0FB7)                                 /* (TCC_WAVEB) Register Mask  */

#define TCC_WAVEB_CICCENB_Pos                 _UINT32_(8)                                          /* (TCC_WAVEB Position) Circular Channel x Enable Buffer */
#define TCC_WAVEB_CICCENB_Msk                 (_UINT32_(0xF) << TCC_WAVEB_CICCENB_Pos)             /* (TCC_WAVEB Mask) CICCENB */
#define TCC_WAVEB_CICCENB(value)              (TCC_WAVEB_CICCENB_Msk & (_UINT32_(value) << TCC_WAVEB_CICCENB_Pos)) 
#define TCC_WAVEB_POLB_Pos                    _UINT32_(16)                                         /* (TCC_WAVEB Position) Channel x Polarity Buffer */
#define TCC_WAVEB_POLB_Msk                    (_UINT32_(0xF) << TCC_WAVEB_POLB_Pos)                /* (TCC_WAVEB Mask) POLB */
#define TCC_WAVEB_POLB(value)                 (TCC_WAVEB_POLB_Msk & (_UINT32_(value) << TCC_WAVEB_POLB_Pos)) 
#define TCC_WAVEB_SWAPB_Pos                   _UINT32_(24)                                         /* (TCC_WAVEB Position) Swap DTI Output Pair 3 Buffer */
#define TCC_WAVEB_SWAPB_Msk                   (_UINT32_(0xF) << TCC_WAVEB_SWAPB_Pos)               /* (TCC_WAVEB Mask) SWAPB */
#define TCC_WAVEB_SWAPB(value)                (TCC_WAVEB_SWAPB_Msk & (_UINT32_(value) << TCC_WAVEB_SWAPB_Pos)) 

/* -------- TCC_PERB : (TCC Offset: 0x6C) (R/W 32) Period Buffer -------- */
#define TCC_PERB_RESETVALUE                   _UINT32_(0xFFFFFFFF)                                 /*  (TCC_PERB) Period Buffer  Reset Value */

#define TCC_PERB_PERB_Pos                     _UINT32_(0)                                          /* (TCC_PERB) Period Buffer Value Position */
#define TCC_PERB_PERB_Msk                     (_UINT32_(0xFFFFFF) << TCC_PERB_PERB_Pos)            /* (TCC_PERB) Period Buffer Value Mask */
#define TCC_PERB_PERB(value)                  (TCC_PERB_PERB_Msk & (_UINT32_(value) << TCC_PERB_PERB_Pos)) /* Assignment of value for PERB in the TCC_PERB register */
#define TCC_PERB_Msk                          _UINT32_(0x00FFFFFF)                                 /* (TCC_PERB) Register Mask  */

/* DITH4 mode */
#define TCC_PERB_DITH4_DITHERCYB_Pos          _UINT32_(0)                                          /* (TCC_PERB) Dithering Buffer Cycle Number Position */
#define TCC_PERB_DITH4_DITHERCYB_Msk          (_UINT32_(0xF) << TCC_PERB_DITH4_DITHERCYB_Pos)      /* (TCC_PERB) Dithering Buffer Cycle Number Mask */
#define TCC_PERB_DITH4_DITHERCYB(value)       (TCC_PERB_DITH4_DITHERCYB_Msk & (_UINT32_(value) << TCC_PERB_DITH4_DITHERCYB_Pos))
#define TCC_PERB_DITH4_PERB_Pos               _UINT32_(4)                                          /* (TCC_PERB) Period Buffer Value Position */
#define TCC_PERB_DITH4_PERB_Msk               (_UINT32_(0xFFFFF) << TCC_PERB_DITH4_PERB_Pos)       /* (TCC_PERB) Period Buffer Value Mask */
#define TCC_PERB_DITH4_PERB(value)            (TCC_PERB_DITH4_PERB_Msk & (_UINT32_(value) << TCC_PERB_DITH4_PERB_Pos))
#define TCC_PERB_DITH4_Msk                    _UINT32_(0x00FFFFFF)                                 /* (TCC_PERB_DITH4) Register Mask  */

/* DITH5 mode */
#define TCC_PERB_DITH5_DITHERCYB_Pos          _UINT32_(0)                                          /* (TCC_PERB) Dithering Buffer Cycle Number Position */
#define TCC_PERB_DITH5_DITHERCYB_Msk          (_UINT32_(0x1F) << TCC_PERB_DITH5_DITHERCYB_Pos)     /* (TCC_PERB) Dithering Buffer Cycle Number Mask */
#define TCC_PERB_DITH5_DITHERCYB(value)       (TCC_PERB_DITH5_DITHERCYB_Msk & (_UINT32_(value) << TCC_PERB_DITH5_DITHERCYB_Pos))
#define TCC_PERB_DITH5_PERB_Pos               _UINT32_(5)                                          /* (TCC_PERB) Period Buffer Value Position */
#define TCC_PERB_DITH5_PERB_Msk               (_UINT32_(0x7FFFF) << TCC_PERB_DITH5_PERB_Pos)       /* (TCC_PERB) Period Buffer Value Mask */
#define TCC_PERB_DITH5_PERB(value)            (TCC_PERB_DITH5_PERB_Msk & (_UINT32_(value) << TCC_PERB_DITH5_PERB_Pos))
#define TCC_PERB_DITH5_Msk                    _UINT32_(0x00FFFFFF)                                 /* (TCC_PERB_DITH5) Register Mask  */

/* DITH6 mode */
#define TCC_PERB_DITH6_DITHERCYB_Pos          _UINT32_(0)                                          /* (TCC_PERB) Dithering Buffer Cycle Number Position */
#define TCC_PERB_DITH6_DITHERCYB_Msk          (_UINT32_(0x3F) << TCC_PERB_DITH6_DITHERCYB_Pos)     /* (TCC_PERB) Dithering Buffer Cycle Number Mask */
#define TCC_PERB_DITH6_DITHERCYB(value)       (TCC_PERB_DITH6_DITHERCYB_Msk & (_UINT32_(value) << TCC_PERB_DITH6_DITHERCYB_Pos))
#define TCC_PERB_DITH6_PERB_Pos               _UINT32_(6)                                          /* (TCC_PERB) Period Buffer Value Position */
#define TCC_PERB_DITH6_PERB_Msk               (_UINT32_(0x3FFFF) << TCC_PERB_DITH6_PERB_Pos)       /* (TCC_PERB) Period Buffer Value Mask */
#define TCC_PERB_DITH6_PERB(value)            (TCC_PERB_DITH6_PERB_Msk & (_UINT32_(value) << TCC_PERB_DITH6_PERB_Pos))
#define TCC_PERB_DITH6_Msk                    _UINT32_(0x00FFFFFF)                                 /* (TCC_PERB_DITH6) Register Mask  */


/* -------- TCC_CCB : (TCC Offset: 0x70) (R/W 32) Compare and Capture Buffer -------- */
#define TCC_CCB_RESETVALUE                    _UINT32_(0x00)                                       /*  (TCC_CCB) Compare and Capture Buffer  Reset Value */

#define TCC_CCB_CCB_Pos                       _UINT32_(0)                                          /* (TCC_CCB) Channel Compare/Capture Buffer Value Position */
#define TCC_CCB_CCB_Msk                       (_UINT32_(0xFFFFFF) << TCC_CCB_CCB_Pos)              /* (TCC_CCB) Channel Compare/Capture Buffer Value Mask */
#define TCC_CCB_CCB(value)                    (TCC_CCB_CCB_Msk & (_UINT32_(value) << TCC_CCB_CCB_Pos)) /* Assignment of value for CCB in the TCC_CCB register */
#define TCC_CCB_Msk                           _UINT32_(0x00FFFFFF)                                 /* (TCC_CCB) Register Mask  */

/* DITH4 mode */
#define TCC_CCB_DITH4_DITHERCYB_Pos           _UINT32_(0)                                          /* (TCC_CCB) Dithering Buffer Cycle Number Position */
#define TCC_CCB_DITH4_DITHERCYB_Msk           (_UINT32_(0xF) << TCC_CCB_DITH4_DITHERCYB_Pos)       /* (TCC_CCB) Dithering Buffer Cycle Number Mask */
#define TCC_CCB_DITH4_DITHERCYB(value)        (TCC_CCB_DITH4_DITHERCYB_Msk & (_UINT32_(value) << TCC_CCB_DITH4_DITHERCYB_Pos))
#define TCC_CCB_DITH4_CCB_Pos                 _UINT32_(4)                                          /* (TCC_CCB) Channel Compare/Capture Buffer Value Position */
#define TCC_CCB_DITH4_CCB_Msk                 (_UINT32_(0xFFFFF) << TCC_CCB_DITH4_CCB_Pos)         /* (TCC_CCB) Channel Compare/Capture Buffer Value Mask */
#define TCC_CCB_DITH4_CCB(value)              (TCC_CCB_DITH4_CCB_Msk & (_UINT32_(value) << TCC_CCB_DITH4_CCB_Pos))
#define TCC_CCB_DITH4_Msk                     _UINT32_(0x00FFFFFF)                                 /* (TCC_CCB_DITH4) Register Mask  */

/* DITH5 mode */
#define TCC_CCB_DITH5_DITHERCYB_Pos           _UINT32_(0)                                          /* (TCC_CCB) Dithering Buffer Cycle Number Position */
#define TCC_CCB_DITH5_DITHERCYB_Msk           (_UINT32_(0x1F) << TCC_CCB_DITH5_DITHERCYB_Pos)      /* (TCC_CCB) Dithering Buffer Cycle Number Mask */
#define TCC_CCB_DITH5_DITHERCYB(value)        (TCC_CCB_DITH5_DITHERCYB_Msk & (_UINT32_(value) << TCC_CCB_DITH5_DITHERCYB_Pos))
#define TCC_CCB_DITH5_CCB_Pos                 _UINT32_(5)                                          /* (TCC_CCB) Channel Compare/Capture Buffer Value Position */
#define TCC_CCB_DITH5_CCB_Msk                 (_UINT32_(0x7FFFF) << TCC_CCB_DITH5_CCB_Pos)         /* (TCC_CCB) Channel Compare/Capture Buffer Value Mask */
#define TCC_CCB_DITH5_CCB(value)              (TCC_CCB_DITH5_CCB_Msk & (_UINT32_(value) << TCC_CCB_DITH5_CCB_Pos))
#define TCC_CCB_DITH5_Msk                     _UINT32_(0x00FFFFFF)                                 /* (TCC_CCB_DITH5) Register Mask  */

/* DITH6 mode */
#define TCC_CCB_DITH6_DITHERCYB_Pos           _UINT32_(0)                                          /* (TCC_CCB) Dithering Buffer Cycle Number Position */
#define TCC_CCB_DITH6_DITHERCYB_Msk           (_UINT32_(0x3F) << TCC_CCB_DITH6_DITHERCYB_Pos)      /* (TCC_CCB) Dithering Buffer Cycle Number Mask */
#define TCC_CCB_DITH6_DITHERCYB(value)        (TCC_CCB_DITH6_DITHERCYB_Msk & (_UINT32_(value) << TCC_CCB_DITH6_DITHERCYB_Pos))
#define TCC_CCB_DITH6_CCB_Pos                 _UINT32_(6)                                          /* (TCC_CCB) Channel Compare/Capture Buffer Value Position */
#define TCC_CCB_DITH6_CCB_Msk                 (_UINT32_(0x3FFFF) << TCC_CCB_DITH6_CCB_Pos)         /* (TCC_CCB) Channel Compare/Capture Buffer Value Mask */
#define TCC_CCB_DITH6_CCB(value)              (TCC_CCB_DITH6_CCB_Msk & (_UINT32_(value) << TCC_CCB_DITH6_CCB_Pos))
#define TCC_CCB_DITH6_Msk                     _UINT32_(0x00FFFFFF)                                 /* (TCC_CCB_DITH6) Register Mask  */


/* TCC register offsets definitions */
...
#define TCC_PATTB_REG_OFST             _UINT32_(0x64)      /* (TCC_PATTB) Pattern Buffer Offset */
#define TCC_WAVEB_REG_OFST             _UINT32_(0x68)      /* (TCC_WAVEB) Waveform Control Buffer Offset */
#define TCC_PERB_REG_OFST              _UINT32_(0x6C)      /* (TCC_PERB) Period Buffer Offset */
#define TCC_CCB_REG_OFST               _UINT32_(0x70)      /* (TCC_CCB) Compare and Capture Buffer Offset */
#define TCC_CCB0_REG_OFST              _UINT32_(0x70)      /* (TCC_CCB0) Compare and Capture Buffer Offset */
#define TCC_CCB1_REG_OFST              _UINT32_(0x74)      /* (TCC_CCB1) Compare and Capture Buffer Offset */
#define TCC_CCB2_REG_OFST              _UINT32_(0x78)      /* (TCC_CCB2) Compare and Capture Buffer Offset */
#define TCC_CCB3_REG_OFST              _UINT32_(0x7C)      /* (TCC_CCB3) Compare and Capture Buffer Offset */

#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
/* TCC register API structure */
typedef struct
